...
call "%~dp0..\gradlew.bat" --init-script "%~dp0enable-api-bootrun.init.gradle" -Dspring.profiles.active=local -x :ghlove-common:copyApplicationYml -x :ghlove-common:processResources :ghlove-api:bootRun
