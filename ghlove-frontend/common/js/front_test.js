...
$(document).ready(function(){
	...
	$('#btn_mobile').click(function () { 
		$(this).addClass('on');
		$('#btn_desktop, #btn_tablet').removeClass('on');
		$('body').removeClass('tablet');
		$('body').addClass('mobile');
		$('.iframe_wrap').removeClass('tablet');
		$('.iframe_wrap').addClass('portrait');

	});
	$('#btn_desktop').click(function () { 
		$(this).addClass('on');
		$('#btn_mobile, #btn_tablet').removeClass('on');
		$('body').removeClass('mobile tablet');
		$('.iframe_wrap').removeClass('portrait landscape tablet');
	});


	/* 2019-03-27 tablet 추가 */
	$('#btn_tablet').click(function () { 
		$(this).addClass('on');
		$('#btn_mobile, #btn_desktop').removeClass('on');
		$('body').removeClass('mobile');
		$('body').addClass('tablet');
		$('.iframe_wrap').removeClass('portrait landscape');
		$('.iframe_wrap').addClass('tablet');
	});
