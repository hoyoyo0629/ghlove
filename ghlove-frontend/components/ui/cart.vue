    ...
    <div>
        ...
        <div class="layer_cart" :class="{'open' : layerCart}">
            <div class="cart_layer_list">
                <div class="guide">선택하신 답례품이 장바구니에 추가되었습니다.</div>
                        ...
                        <div class="col-9 col-md-11 col-xl-9">
                            <div class="txt_area">
                                ...
                                <button type="button" class="btn_itemDel" @click.prevent="deleteCart(data.cartId)">
                                    <img src="/static/images/icon/btn_del.png" alt="답례품삭제">
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row totalBox">
                    <div class="col-6 txt">총 답례품금액</div>
                    <div class="col-6 price"><span>{{orderPrice ? formatNumber(orderPrice.orderPayAmount) : 0}}</span>원
                    </div>
                </div>
                <div class="btn_wrap">
                    <a href="/cart/index.html" class="btn btn_outline_light">장바구니 가기</a>
    ...
    module.exports = {
        ...
        methods: {
            ...
            deleteCart: function (cartId) {
                let self = this;
                $s.confirm("선택하신 답례품을 장바구니에서 삭제하시겠습니까?", function () {
