		...
		<div class="header_top">
			<div class="container">
				<div class="row no-gutters top_area">
					<div class="col-6">
						<h1 class="logo">
							<a href="/"><img src="/static/images/logo.png" alt="고향사랑e음 로고"></a>
						</h1>
					</div>
					<div class="col-6">
											...
											<div class="search_top">
												<form @submit.prevent="searchSubmit">
													<input type="text" v-model="searchWord" class="form-control"
													    :placeholder="recommendSearch != null && recommendSearch.searchContents != null ? recommendSearch.searchContents : '검색어를 입력하세요'">
												</form>
											</div>
