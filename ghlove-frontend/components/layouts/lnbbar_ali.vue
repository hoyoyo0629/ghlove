				...
				<div class="swiper-contents">
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide" :class="showGnbTargetFlag('new') ? 'on' : ''"><a
									href="/event/new.html">신상품</a></li>
							<li class="swiper-slide" :class="showGnbTargetFlag('best') ? 'on' : ''"><a
									href="/event/best.html">베스트</a></li>
							<li class="swiper-slide" :class="showGnbTargetFlag('spot') ? 'on' : ''"><a
									href="/event/spot.html">타임세일</a></li>
							<li class="swiper-slide" :class="showGnbTargetFlag('featured') ? 'on' : ''"><a
									href="/featured/list.html">기획전</a></li>
							<li class="swiper-slide" :class="showGnbTargetFlag('stylebook') ? 'on' : ''">
								<a href="/event/stylebook.html">룩북</a></li>
						</ul>
						...
						<dl v-for="category1 in group.categories" :key="category1.url">
							...
							<dd class="depth2_area" v-for="category2 in category1.childCategories"
								...
								<a href="javascript:void(0);"
									@click="link(category2.url, category2.childCategories)"
									class="depth2_tit">{{category2.name}}</a>

								<template v-if="category2.childCategories.length > 0">

									<ul class="depth3">
										<li class="depth3_area"
											v-for="category3 in category2.childCategories"
