<template>
  <header id="header" class="header2" v-if="!exportMode">
    <ul id="go_main">
      <li><a href="#contents" rel="nosublink nofollow">본문 바로가기</a></li>
      <li><a href="#gnb" rel="nosublink nofollow">주메뉴 바로가기</a></li>
    </ul>
        ...
        <div class="top-navi">
          <div class="user-status-info" v-if="!showLogin">
            <span class="top_navi_info">
              <span class="db-userName cBlue">{{ userStatusInfoData.userName }}</span>
              회원님 환영합니다.
            </span>
            <span class="top_navi_info">
              기부총액
              <span class="db-totalPoint cBlue">{{ formatNumber(userStatusInfoData.userTotalDonation) }} 원</span>
            </span>
            <span class="top_navi_info">
              기부포인트
              <span class="db-totalPoint cBlue">{{ formatNumber(userStatusInfoData.userDonationPoint) }} P</span>
            </span>
          </div>
          ...
          >
            <img class="icon-img" src="/static/images/icon/cli-icon_logout.png" alt="" title="로그아웃 하기" />
            로그아웃
          </button>
          <button type="button" class="btn_login d-none d-md-block" v-else-if="showLogin" @click.prevent="goLogin">
            <img class="icon-img" src="/static/images/icon/cli-icon_login.png" alt="" title="로그인 하기" />
            로그인
          </button>

          <button type="button" v-if="!showLogin" @click="getMyReceipt()" class="btn_mypage d-none d-md-block">
            <img class="icon-img" src="/static/images/icon/trophy.png" alt="" title="기부확인증" style="opacity: 60%;"/>
            기부확인증
          </button>

          <button type="button" v-if="!showLogin" @click="getMyPage()" class="btn_mypage d-none d-md-block">
            <img class="icon-img" src="/static/images/icon/cli-icon_mypage.png" alt="" title="마이페이지" />
            마이페이지
          </button>
          ...
          >
            <img class="icon-img" src="/static/images/icon/cli-icon_mypage.png" alt="" title="회원가입" />
            회원가입
          </button>

          <button type="button" class="btn_cart" @click="openPresent('sbag')">
            <span class="cartIconWrap">
              <img class="icon-img" src="/static/images/icon/cli-icon_cart.png" alt="" />
              <span class="badge badge_cart" style="display: none">{{ cartQuantity }}</span>
            </span>
            장바구니
          </button>
          <button type="button" class="btn_orderList" @click="getOrderList()">
            <img class="icon-img" src="/static/images/icon/order-inquiry.png" alt="" />
            주문조회
          </button>

          <button type="button" class="btn_orderList" @click="goCatalog()">
            <img class="icon-img" src="/static/images/icon/cli-icon_news.png" alt="" />
            소식지
          </button>
        </div>
      </div>
      ...
      <div class="container">
        <h1 class="logo">
          <a href="/" rel="nosublink nofollow"
            ...
            <span v-if="isDevelopment">개발테스트</span>
          </a>
          <!-- <span v-if="isDevelopment">
              <a href="/opmanager">
            	  <span>( >> 관리자페이지 접속 )<span class="underLine"></span></span>
              </a>
            </span> -->
        </h1>
        <nav id="gnb">
          <ul class="main-menu">
            <li>
              <a href="javascript:void(0);" onclick="javascript:$s.donation.goDonationPage();" rel="nosublink nofollow">
              ...
              <ul class="sub-menu">
                ...
                <li>
                  <a href="/designated-donation/index.html">특정사업에 기부하기</a>
                </li>
                <li>
                  <a href="/donation/list-select.html" rel="nosublink nofollow">기금사업 소개</a>
                </li>
                <li><a href="/featured/eventList.html" rel="nosublink nofollow">지역이벤트</a></li>
              </ul>
            </li>
            <li>
              <a href="/donation/guide1.html" rel="nosublink nofollow">
                <span>기부안내<span class="underLine"></span></span>
              </a>
              <ul class="sub-menu">
                <li><a href="/donation/guide1.html">고향사랑기부제 안내</a></li>
                <li>
                  <a href="/donation/guide2.html" rel="nosublink nofollow">온라인 기부절차 안내</a>
                </li>
                <li>
                  <a href="/donation/guide5.html" rel="nosublink nofollow">오프라인 기부절차 안내</a>
                </li>
                <li>
                  <a href="/donation/guide3.html" rel="nosublink nofollow">기부금 연말정산 세액공제 안내</a>
                </li>
                <!-- <li><a href="/donation/guide4.html">종합소득세 확정신고 서비스 안내</a> </li> -->
                <li>
                  <a href="/donation/guide6.html" rel="nosublink nofollow">고향사랑기부 주의사항</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="/goods/index.html" rel="nosublink nofollow">
                <span>답례품<span class="underLine"></span></span
              ></a>
              <ul class="sub-menu">
                <li><a href="/goods/index.html">답례품몰</a></li>
                <!--<li><a href="/featured/eventList.html">지역이벤트</a></li>-->
                <li><a href="/event/seasonList.html" rel="nosublink nofollow">제철식품관</a></li>
                <!--<li><a href="/event/specialityList.html">특산물관</a></li>-->
              </ul>
            </li>
            <li>
              <a href="/notice/list.html" rel="nosublink nofollow">
                <span>고객센터<span class="underLine"></span></span>
              </a>
              <ul class="sub-menu">
                <li><a href="/notice/list.html" rel="nosublink nofollow">공지사항</a></li>
                <li><a href="/data-board/list.html" rel="nosublink nofollow">자료실</a></li>
                <li><a href="/qna/qna-open.html" rel="nosublink nofollow">Q&A</a></li>
                <li><a href="/faq/list.html">FAQ</a></li>
                <!--<li><a href="/guide/help.html">도움말</a></li>-->
                <li><a href="/guide/sitemap.html" rel="nosublink nofollow">사이트맵</a></li>
              </ul>
            </li>
          </ul>
          <div class="icon_wrapper">
            <!--<div class="total_search">
              <button type="button" id="searchBtn" @click.prevent="searchModal($event)">
                <img class="icon-img" src="/static/images/icon/icon_total_search2_S.png" alt="통합검색">
                <span>통합검색</span>
              </button>
            </div>-->
            <div class="hamberger">
              <button type="button" id="totalMenuBtn" @click.prevent="sitemapModal($event)">
                <img class="icon-img" src="/static/images/icon/cli-icon_hamberger.png" alt="전체메뉴" />
              </button>
            </div>
          </div>
        </nav>
        ...
        <nav class="m_top-navi">
        	<nav>
        		<button type="button" v-if="!showLogin" @click="getMyReceipt()">
            		<img class="icon-img" src="/static/images/icon/trophy.png" title="기부확인증"/>
        		</button>
    		</nav>
          <a href="/users/login.html" class="btn_login" v-if="showLogin" rel="nosublink nofollow">
            <img class="icon-img" src="/static/images/icon/m-icon_login.png" alt="로그인" />
          </a>
    ...
    <div class="m-all-menu" id="m-all-menu">
      <div class="m-all-menu-wrap">
        <div class="top-navi">
          <button type="button" class="btn_cart" @click="openPresent('sbag')">
            <span class="cartIconWrap">
              <img class="icon-img" src="/static/images/icon/m-cart.png" alt="장바구니로 이동" />
              <span class="badge badge_cart" style="display: none">{{ cartQuantity }}</span>
            </span>
          </button>
          ...
          <button type="button">
            <img class="icon-img" src="/static/images/icon/cli-icon_btn-close.png" alt="" id="closebtn" />
          </button>
        </div>
        <div class="quick_navi">
          <button type="button" v-if="!showLogin" @click="getMyPage()" class="btn_mypage d-md-block">
            <img
              class="icon-img"
          ...
          <button type="button" v-else-if="showLogin" @click="goToJoinPageBefore()" class="btn_mypage d-md-block">
            <img
              class="icon-img"
              src="/static/images/icon/cli-icon_mypage.png"
              alt="회원가입으로 이동"
          ...
          <button type="button" class="btn_orderList" @click="getOrderList()">
            <img class="icon-img" src="/static/images/icon/order-inquiry.png" alt="주문조회로 이동" />
            주문조회
          </button>
        </div>
        <div class="container">
          <div class="user-status-info" v-if="!showLogin">
            <div class="info-top">
              ...
              <button class="btn_logout d-md-block" v-if="!showLogin" @click.prevent="logout">
                <img class="icon-img" src="/static/images/icon/logout-white.png" alt="" title="로그아웃 하기" />
                로그아웃
              </button>
            </div>
            <div class="user-data">
              <div class="user_data_cols">
                <span class="pointblue"
                  ><img class="icon-img" src="/static/images/icon/cli-icon_my-amount-all.png" alt="" /> 기부총액</span
                >
                <span class="db-totalPoint cBlue">{{ formatNumber(userStatusInfoData.userTotalDonation) }} 원</span>
              </div>
              <div class="user_data_cols">
                <span class="pointblue"
                  ><img class="icon-img" src="/static/images/icon/cli-icon_my-point.png" alt="" />기부포인트</span
                >
                <span class="db-totalPoint cBlue">{{ formatNumber(userStatusInfoData.userDonationPoint) }} P</span>
              </div>
            </div>
          ...
          <div class="user-status-info" v-else-if="showLogin">
            <div class="info-top">
              ...
              <a href="/users/login.html" class="btn_login d-md-block" v-if="showLogin" rel="nosublink nofollow">
                <img
                  class="icon-img"
          ...
          <div class="all-menu">
            <nav class="m-all-menu-list">
              <ul class="all-main-menu mobileM">
                <li class="dropdown">
                  <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" rel="nosublink nofollow"
                    >기부하기</a
                  >
                ...
                <li class="dropdown">
                  ...
                  <ul class="all-sub-menu dropdown-menu" aria-label="dLabel">
                    ...
                    <li>
                      <a href="/donation/guide2.html" rel="nosublink nofollow">온라인 기부절차안내</a>
                    </li>
                    <li>
                      <a href="/donation/guide5.html" rel="nosublink nofollow">오프라인 기부절차안내</a>
                    </li>
                    <li>
                      <a href="/donation/guide3.html" rel="nosublink nofollow">기부금 연말정산 세액공제 안내</a>
                    </li>
                ...
                <li class="dropdown">
                  <a href="/goods/index.html" class="dropdown-toggle" data-toggle="dropdown" rel="nosublink nofollow"
                    >답례품</a
                  >
                  <ul class="all-sub-menu dropdown-menu" aria-label="dLabel">
                    <li><a href="/goods/index.html">답례품몰</a></li>
                ...
                <li class="dropdown">
                  <a href="/notice/list.html" class="dropdown-toggle" data-toggle="dropdown" rel="nosublink nofollow"
                    >고객센터</a
                  >
                  <ul class="all-sub-menu dropdown-menu" aria-label="dLabel">
                    <li><a href="/notice/list.html" rel="nosublink nofollow">공지사항</a></li>
                ...
                <li class="dropdown">
                  <a href="/mypage/index.html" class="dropdown-toggle" data-toggle="dropdown" rel="nosublink nofollow"
                    >마이페이지</a
                  >
                  <ul class="all-sub-menu dropdown-menu" aria-label="dLabel">
                    <li><a href="/mypage/index.html" rel="nosublink nofollow">마이페이지</a></li>
                    <li>
                      <a href="/mypage/cntrList.html" rel="nosublink nofollow">기부</a>
                      <ul class="all-sub-sub-menu">
                        <li>
                          <a href="/mypage/cntrList.html" rel="nosublink nofollow">기부내역 현황</a>
                        </li>
                        <li>
                          <a href="/mypage/cntrPoint.html" rel="nosublink nofollow">기부포인트 현황</a>
                        </li>
                        <li>
                          <a href="/mypage/receiptList.html" rel="nosublink nofollow">기부확인증</a>
                        </li>
                        <li>
                          <a href="/mypage/honorList.html" rel="nosublink nofollow">기부혜택증(지자체별)</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <a href="/mypage/orderList.html" rel="nosublink nofollow">답례품</a>
                      <ul class="all-sub-sub-menu">
                        <li><a href="/mypage/orderList.html" rel="nosublink nofollow">주문조회</a></li>
                        <li>
                          <a href="/mypage/orderCancel.html" rel="nosublink nofollow">취소반품교환</a>
                        </li>
                        <li><a href="/mypage/review.html" rel="nosublink nofollow">답례품후기</a></li>
                        <li>
                          <a href="/mypage/inquiryItem.html" rel="nosublink nofollow">답례품Q＆A</a>
                        </li>
                        <li>
                          <a href="/mypage/deliveryInfo.html" rel="nosublink nofollow">배송지 관리</a>
                        </li>
                        <li><a href="/cart/index.html" rel="nosublink nofollow">장바구니</a></li>
                      </ul>
                    </li>
                    <li>
                      <a href="/mypage/intrstLocGov.html" rel="nosublink nofollow">관심정보</a>
                      <ul class="all-sub-sub-menu">
                        <li>
                          <a href="/mypage/intrstLocGov.html" rel="nosublink nofollow">관심지자체</a>
                        </li>
                        <li><a href="/mypage/favorItem.html" rel="nosublink nofollow">관심답례품</a></li>
                      </ul>
                    </li>
                    <li><a href="/users/modify.html" rel="nosublink nofollow">회원정보수정</a></li>
                    <li><a href="/mypage/inquiry.html" rel="nosublink nofollow">1:1 문의</a></li>
                    <!--<li><a href="/mypage/honorList.html">기부확인증</a></li>-->
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="/users/join.html" class="dropdown-toggle" data-toggle="dropdown" rel="nosublink nofollow"
                    >로그인</a
                  >
                  <ul class="all-sub-menu dropdown-menu" aria-label="dLabel">
                    <li>
                    ...
                    <li>
                      <a href="/users/login.html" v-if="showLogin" rel="nosublink nofollow">로그인</a>
                      <ul class="all-sub-sub-menu" v-if="showLogin">
                        <li><a href="/users/login.html" rel="nosublink nofollow">아이디 로그인</a></li>
                        <li>
                          <a href="/users/login.html" rel="nosublink nofollow">간편/금융 인증 로그인</a>
                        </li>
                        <li>
                          <a href="/users/login.html" rel="nosublink nofollow">디지털원패스 로그인</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <a href="/users/find-idpw.html" v-if="showLogin" rel="nosublink nofollow"
                        >아이디 / 비밀번호 찾기</a
                      >
                      <ul class="all-sub-sub-menu" v-if="showLogin">
                        <li><a href="/users/find-idpw.html" rel="nosublink nofollow">아이디 찾기</a></li>
                        <li>
                          <a href="/users/find-idpw.html" rel="nosublink nofollow">비밀번호 찾기</a>
                        </li>
                      </ul>
                    </li>
                    <li><a href="/policy/auth.html" rel="nosublink nofollow">이용약관</a></li>
                    <li><a href="/policy/privacy.html" rel="nosublink nofollow">개인정보처리방침</a></li>
                    <li><a href="/policy/copyright.html" rel="nosublink nofollow">저작권정책</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
...
module.exports = {
  ...
  methods: {
    ...
    searchSubmit: function () {
      ...
      if (word === "" && recommend != null && recommend.searchContents != null && recommend.searchContents !== "") {
        ...
        // 팝업 혹은 링크 연결
        if (targetBlank) {
          window.open(searchLink, recommend.searchContents, "noopener,noreferrer");
        } else {
      ...
      /*
        $s.api.getSubmit('/api/present/login', '', function (response) {
          ...
          if (response.isSuccess) {
            ...
            window.open(domain + '?_tss_=' + param, 'presentPopup', '_blank', 'noopener,noreferrer');
          }
        });
        */
    ...
    saveUserActionLog: function () {
      $s.api.saveUserActionLog({ requestUri: location.pathname }, function () {});
    },
    goLogin: function () {
  ...
  mounted: function () {
    this.$nextTick(function () {
      ...
      window.onpageshow = function (event) {
        if (event.persisted || (window.performance && window.performance.navigation.type == 2)) {
          ...
          if (typeof header.$parent.onPageShow == "function") {
            header.$parent.onPageShow();
          }
        }
      };
    });
    setTimeout(() => {
      ...
      if (!!document.querySelector(".lnb ul li a.currentT")) {
        document.querySelector(".lnb ul li a.currentT").append(span);
      }
    }, 1000);
  },
};
