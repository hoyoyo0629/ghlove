                  ...
                  <div class="center">
                        <div class="gnb_slider_m">
                              ...
                              <span class="local_shop" @click="selectMenuOpen($event)">
                                    <button type="button" class="shop_select">
                                    ...
                                    <span class="goods_loc_search" @click.stop="">
                                          <select name="upperLocgovCode" id="upperLocgovCode" v-model="sidoCode"
                                                @change="changeSidoEvent" title="시·도 선택">
                                          ...
                                          <select name="locgovCodeSet" id="locgovCodeSet" v-model="sigunguCode"
                                                @change="changeSigunguEvent" title="시·군·구 선택">
                                                <option v-for="(sigungu, index) in sigunguList" :value="sigungu.cityCode"
                                                      :key="index">
                                                      {{ sigungu.cityName }}
                                                </option>
                                          </select>
                                          <span class="btn-box">
                                                <!-- <button type="button" class="formBtn" @click="this.$s.redirect('/goods/index.html')">통합몰 가기</button> -->
