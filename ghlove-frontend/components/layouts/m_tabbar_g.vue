        ...
        <nav class="goods_lnb">
            <div class="tabbar">
                <div class="center">
                    ...
                    <a href="javascript:void(0);" :class="{ 'on': false }" @click="getMyPage()" v-if="!exportMode">
                        <span class="tabbar_icon"></span>
        ...
        <div class="loc_search" id="goodsSearch">
            <div class="loc_search_area">
                ...
                <span class="goods_search" tabindex="0">
                    <input type="text" placeholder="답례품 검색" title="답례품 검색" @keydown='keydown' v-model="searchKeyword">
