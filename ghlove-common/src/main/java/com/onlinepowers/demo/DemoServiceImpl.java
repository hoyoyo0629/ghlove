...
@Service("demoService")
public class DemoServiceImpl extends EgovAbstractServiceImpl implements DemoService {
...
//				log.error(e.getMessage(), e);
				log.error(getClass().getName() + " :: execute InterruptedException ==============");
...
//				log.error(e.getMessage(), e);
				log.error(getClass().getName() + " :: send InterruptedException ==============");
				Thread.currentThread().interrupt();
			}
		}
...
//			log.error(e.getMessage(), e);
			log.error(getClass().getName() + " :: send2 InterruptedException ==============");
			Thread.currentThread().interrupt();
		}
		long eTime = System.currentTimeMillis();
...
//			log.error(e.getMessage(), e);
			log.error(getClass().getName() + " :: updateUserAddress IOException ==============");
		} catch (Exception e) {
//			log.error(e.getMessage(), e);
			log.error(getClass().getName() + " :: updateUserAddress Exception ==============");
		}
	}
...
//			log.error(e.getMessage(), e);
			log.error(getClass().getName() + " :: insertAllowIp RuntimeException ==============");
