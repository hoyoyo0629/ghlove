...
public class ShopContext implements Serializable {
	...
	private CommonTrackingScript commonTrackingScript;
	...
	public CommonTrackingScript getCommonTrackingScript() {
		return commonTrackingScript;
	}

	public void setCommonTrackingScript(CommonTrackingScript commonTrackingScript) {
		this.commonTrackingScript = commonTrackingScript;
	}
}
