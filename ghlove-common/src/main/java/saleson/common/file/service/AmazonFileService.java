...
public class AmazonFileService implements FileService {
	...
	@Override
	public void uploadTempEditor(MultipartFile multipartFile, UploadFile uploadFile) {
		if(multipartFile != null && uploadFile != null) {
			...
			try (
				...
				if (UploadTypeFactory.INSTANCE != null
						&& UploadTypeFactory.INSTANCE.getType(uploadFile.getUseEncrypt()) != null
						&& UploadTypeFactory.INSTANCE.getType(uploadFile.getUseEncrypt()).getHandler() != null) {
					UploadTypeFactory.INSTANCE.getType(uploadFile.getUseEncrypt()).getHandler().upload(is, fos);
		            //fileStorage.upload(multipartFile.getBytes(), saveFile);
					...
					new IOException("파일 업로드 실패 - " + getClass().getName() + " :: uploadTempEditor");
				}
	        } catch (IOException e) {
	            throw new RuntimeException(e);
	        }
			...
			new IOException("파일 업로드 실패 - 파일없음 :: uploadTempEditor");
		}
	}
...
//						log.error("파일 복사 에러 : {} " , ignore.getMessage());
						log.error(getClass().getName() + " :: upload IOException =================");
					}
...
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail IOException =================");
				}			// 썸네일 생성
				catch (InvalidKeyException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail InvalidKeyException =================");
				} catch (NoSuchAlgorithmException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail NoSuchAlgorithmException =================");
				} catch (IllegalBlockSizeException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail IllegalBlockSizeException =================");
				} catch (NoSuchPaddingException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail NoSuchPaddingException =================");
				} catch (BadPaddingException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail BadPaddingException =================");
				} catch (InvalidKeySpecException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail InvalidKeySpecException =================");
				} catch (InvalidAlgorithmParameterException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error(getClass().getName() + " :: createThumbnail InvalidAlgorithmParameterException =================");
				}
        	}
		}
	}
