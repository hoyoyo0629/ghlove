...
public class LocalFileService implements FileService {
	...
	public void uploadTempSWF(MultipartFile multipartFile, UploadFile uploadFile) {
    	...
    	if(saveFile != null && multipartFile != null) {
	...
	public void uploadTempEditor(MultipartFile multipartFile,
    	...
    	if (saveFile != null && editorSaveFile != null ) {
    		try (FileOutputStream fos = new FileOutputStream(saveFile);
    				InputStream is = multipartFile.getInputStream();
			...
			for (int tempFileId : tempFileIds) {
				if (tempFileId != 0) {
					...
					try {
						...
						log.error(getClass().getName() + " uploadProcessByTempFileIds error", e);
					}
...
//						log.error("파일 복사 에러 : {} " , ignore.getMessage());
						log.error("파일 복사 에러 : {} " , getClass().getName() + " :: upload IOException ==============", ignore);
					}
...
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail IOException ==============", e);
				}			// 썸네일 생성
				catch (InvalidKeyException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail InvalidKeyException ==============", e);
				} catch (NoSuchAlgorithmException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail NoSuchAlgorithmException ==============", e);
				} catch (IllegalBlockSizeException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail IllegalBlockSizeException ==============", e);
				} catch (NoSuchPaddingException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail NoSuchPaddingException ==============", e);
				} catch (BadPaddingException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail BadPaddingException ==============", e);
				} catch (InvalidKeySpecException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail InvalidKeySpecException ==============", e);
				} catch (InvalidAlgorithmParameterException e) {
					// TODO Auto-generated catch block
//					e.printStackTrace();
					log.error("Error : {} " , getClass().getName() + " :: createThumbnail InvalidAlgorithmParameterException ==============", e);
				}
        	}
		}
	}
