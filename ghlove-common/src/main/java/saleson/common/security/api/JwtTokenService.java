...
public class JwtTokenService {
	...
	public String getJwtToken(HashMap<String, Object> claims) {
		...
		try {
			...
			log.error("JwtTokenService getJwtToken SecretKey Error: {}");
		}
	...
	public String getJwtToken(String loginType, String loginId, String encodePassword, String ip) {
		...
		} catch (IllegalArgumentException | InvalidKeyException | UnsupportedEncodingException | NoSuchAlgorithmException e) {
			log.error("JwtTokenService getJwtToken TokenSign Error: {}");
		}
	...
	public String getJwtRequestToken(long userId, String requestToken, long minute) {
		...
		try {
			...
			log.error("JwtTokenService getJwtRequestToken Error: {}");
		}
	...
	public String getJwtGuestToken(String userName, String phoneNumber) {
		...
		try {
			...
			log.error("JwtTokenService getJwtGuestToken OpRuntimeException Error: {}");
		} catch (Exception e) {
			log.error("JwtTokenService getJwtGuestToken Exception Error: {}");
		}
	...
	public Jws<Claims> getClaimsByToken(String token) {
	...
	public boolean isRequestTokenAuthentication(String jwtToken, String reqeustToken, Jws<Claims> claims) {
		...
		} catch (OpRuntimeException igroe) {
			return false;
		}
	...
	public boolean validateToken(String token, TokenAuthUserInfo tokenAuthUserInfo) {
