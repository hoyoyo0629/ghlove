...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "JwtUtils :: generateTokenSecureKey RuntimeException ================");
            return "";
        }
     ...
     * @throws Exception
     */
    public static Object getValueByToken(String token, String key) {
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "JwtUtils :: getErrorMessage RuntimeException ================");
        }
        return message;
    }
     ...
     * @throws Exception
     */
    public static String getTokenSign(TokenAuthUserInfo tokenAuthUserInfo) throws IllegalArgumentException, InvalidKeyException, UnsupportedEncodingException, NoSuchAlgorithmException{
     ...
     * @throws Exception
     */
    public static String getRequestTokenSign(RequestTokenInfo requestTokenInfo) throws IllegalArgumentException, InvalidKeyException, UnsupportedEncodingException, NoSuchAlgorithmException{
        return EncryptionUtils.getHmacSHA256(
                JwtUtils.getCode(JwtCode.TOKEN_SIGN_SECURE_KEY),
     ...
     * @throws Exception
     */
    public static String getGuestUserTokenSign(TokenAuthGuestUserInfo info) throws IllegalArgumentException, InvalidKeyException, UnsupportedEncodingException, NoSuchAlgorithmException{
        return EncryptionUtils.getHmacSHA256(
                JwtUtils.getCode(JwtCode.TOKEN_SIGN_SECURE_KEY),
    ...
    public static GuestUser getGuestUser(String token) {
        try {
            ...
            log.error("JwtUtils :: getGuestUser RuntimeException1 ================");
            return null;
        } catch (Exception e) {
//          log.error("getGuestUserByToken Error", e);
        	log.error("JwtUtils :: getGuestUser Exception1 ================");
        	return null;
        }
    }
    ...
    public static GuestUser getGuestUser(HttpServletRequest request) {
        try {
            ...
            log.error("JwtUtils :: getGuestUser RuntimeException2 ================");
            return null;
        } catch (Exception e) {
//          log.error("getGuestUserByToken Error", e);
        	log.error("JwtUtils :: getGuestUser Exception2 ================");
        	return null;
        }
    }
}
