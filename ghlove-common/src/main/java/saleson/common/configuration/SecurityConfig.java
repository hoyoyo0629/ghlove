...
import saleson.common.security.crypto.AesCryptor;
import saleson.common.security.crypto.Cryptor;
import saleson.common.security.crypto.DefaultCryptor;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CsrfSecurityRequestMatcher csrfMatcher() {
        return new CsrfSecurityRequestMatcher(
                ...
                "/m/google-analytics/**" // google analytics
...
//    }
    ...
    public Cryptor cryptor() {
        // AES-256, mysql 암호화 함수 대응
        //return new AesCryptor(environment.getProperty("security.cryptor.key"));
