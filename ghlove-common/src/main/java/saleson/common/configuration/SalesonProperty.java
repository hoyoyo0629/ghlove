...
public class SalesonProperty extends PropertiesUtils {
	...
	private static String salesonUrlCdn;
	...
	private static String emsHost;
	private static String emsSendUsername;
	private static String emsSendEmail;
	private static boolean  salesonAuthManagerProcess;
	private static long salesonAuthManagerTime;
	...
	@Value("${saleson.url.cdn}")
	public void setSalesonUrlCdn(String value) {
		salesonUrlCdn = value;
	}
	...
	public void setFileStorageType(String value) {
		fileStorageType = value;
	}
	@Value("${ems.host}")
	public void setEmsHost(String value) {
		emsHost = value;
	}
	@Value("${ems.send.username}")
	public void setEmsSendUsername(String value) {
		emsSendUsername = value;
	}
	@Value("${ems.send.email}")
	public void setEmsSendEmail(String value) {
		emsSendEmail = value;
	}
	@Value("${saleson.auth.manager.process}")
	public void setSalesonAuthManagerProcess(boolean value) {
		salesonAuthManagerProcess = value;
	}
	@Value("${saleson.auth.manager.time}")
	public void setSalesonAuthManagerTime(long value) {
		salesonAuthManagerTime = value;
	}
	...
	public static String getSalesonUrlCdn() {
		return salesonUrlCdn;
	}
	...
	public static String getEmsHost() {
		return emsHost;
	}
	public static String getEmsSendUsername() {
		return emsSendUsername;
	}
	public static String getEmsSendEmail() {
		return emsSendEmail;
	}
	public static boolean isSalesonAuthManagerProcess() {
		return salesonAuthManagerProcess;
	}
	public static long getSalesonAuthManagerTime() {
		return salesonAuthManagerTime;
	}
}
