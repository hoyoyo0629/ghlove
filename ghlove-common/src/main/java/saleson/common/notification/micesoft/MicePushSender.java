...
public class MicePushSender implements PushSender {
    ...
    public void sendMessage(OpMessage opMessage) {
        ...
        } catch (OpRuntimeException | JsonProcessingException ignore) {
    ...
    private Pushmsg getPushmsg(OpMessage opMessage) throws OpRuntimeException {
        ...
        try {
            ...
            log.error("MicePushSender getPushmsg Error", ignore);
        }
        ...
        if (expansionInfo != null) {
            ...
            if (!ObjectUtils.isEmpty(failedType) && "SMS".equals(failedType)) {
                ...
                if (!ObjectUtils.isEmpty(failedImg)) {
                    failedType = "MMS";
                }
            }
        ...
        String testYn = environment.getProperty("ums.push.test");
        String kind = "CCS";
        String customData = "";


        if (ObjectUtils.isEmpty(testYn)) {
            testYn = "Y";
        }
