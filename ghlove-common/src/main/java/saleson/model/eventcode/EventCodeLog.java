...
@SequenceGenerator(
		name = "EVENT_CODE_LOG_SEQ_GENERATOR"
		, sequenceName = "OP_EVENT_CODE_LOG_SEQ"
		, initialValue = 2160000
		, allocationSize = 1)
@Getter
@Setter
@AllArgsConstructor
...
public class EventCodeLog extends BaseEntity {
	...
	private static final Logger log = LoggerFactory.getLogger(EventCodeLog.class);

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EVENT_CODE_LOG_SEQ_GENERATOR")
    private Long id;
    ...
    private void init() {
        ...
        setEventUid(EventViewUtils.getUid());
    ...
    private void setParam(String key, Map<String, String> map) {
        ...
        if (!ObjectUtils.isEmpty(value)) {
            switch (key) {
                ...
                case "uid": setEventUid(value); break;
                ...
                case "source_user_id":
                    ...
                    try {
                    	...
                    	log.error(getClass().getName() + " setParam error", ignore);
                    }
