...
@SequenceGenerator(
		name = "CONFIG_GOOGLE_ANALYTICS_SEQ_GENERATOR"
		, sequenceName = "OP_CONFIG_GOOGLE_ANALYTICS_SEQ"
		, initialValue = 6750
		, allocationSize = 1)
@Data
@AllArgsConstructor
...
public class ConfigGoogleAnalytics {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CONFIG_GOOGLE_ANALYTICS_SEQ_GENERATOR")
    private Long id;
