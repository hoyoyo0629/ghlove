...
public class CampaignQueryConst {
    ...
    public static final String INSERT_CAMPAIGN_BATCH = "INSERT INTO OP_CAMPAIGN_BATCH \n" +
         ...
         "\tU.LOGIN_DATE AS LAST_LOGIN_DATE,\n" +
    ...
    public static final String TEST_G_CNTR_SUNAP_SUCCESS = "UPDATE G_CNTR gc\n"
    		...
    		+ "         , gc.LAST_UPDUSR_ID = :userId\n"
    		+ "         , gc.DELETE_AT = 'N'\n"
    		+ "         , gc.LAST_UPDT_PNTTM = DATE_FORMAT(NOW(),'%Y%m%d%H%i%s')\n"
    		+ "     WHERE gc.ELCTRN_PAY_NO = :elctrnPayNo"
    		;
    
    public static final String DELETE_SMS_LOG_TEMP = "DELETE FROM OP_SMS_LOG_TEMP";
    public static final String DELETE_MMS_LOG_TEMP = "DELETE FROM OP_MMS_LOG_TEMP";
    public static final String DELETE_PUSH_LOG_TEMP = "DELETE FROM OP_PUSH_LOG_TEMP";
    public static final String DELETE_KAKAO_LOG_TEMP = "DELETE FROM OP_KAKAO_LOG_TEMP";
}
