...
public class UserGroupServiceImpl extends EgovAbstractServiceImpl implements UserGroupService {
	...
	public void userGroupSetting(UserGroup userGroup) {
		...
		if (ObjectUtils.isEmpty(userGroup.getGroupCode())) {
	...
	public int getUserGroupCount(UserGroupParam userGroupParam) {
		...
		return userGroupMapper.getUserGroupCount(userGroupParam);
	}
	...
	public List<Group> getUserGroupList(UserGroupParam userGroupParam) {
		// TODO Auto-generated method stub
		return userGroupMapper.getUserGroupList(userGroupParam);
	}
	...
	public void insertGroup(UserGroup group) {
		userGroupMapper.insertGroup(group);
//		reload();
	}
	 ...
	 */
	@Override
	public UserGroup getGroupById(Map<String, Object> params) {
		return userGroupMapper.getGroupById(params);
	}
	...
	public void updateGroup(UserGroup group) {
		userGroupMapper.updateGroup(group);
		// reload();
	}
	...
	public void deleteGroup(UserGroup group) {
		userGroupMapper.deleteGroup(group);
		// reload();
	}
