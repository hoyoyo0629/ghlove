...
public interface ItemService {
	 ...
	 * @return
	 */
	BenefitInfo getBenefitInfoByItemId(int itemId);
	 ...
	 * @return
	 */
	CustomerInfo getCustomerInfoByItemId(int itemId);
	 ...
	 * @param listParam
	 */
	void deleteItemReviewList(ListParam listParam);
	 ...
	 * @return
	 */
//	public void deleteLclgvRprsGds(ItemParam param);
	 ...
	 * */
	void insertLclgvOffRprsGds(List<Map<String, String>> optionList, boolean isInsert);
