...
public class ItemParam extends SearchParam implements Cloneable {
	...
	private String srchDateType = "";		// 검색일자 구분
	...
	private String categoryLeve2;
	private String categoryLeve3;
	private String categoryLeve4;
	private String locgov;
	private String isSidoYn;
	private int price;
...
//			log.error("getTodayIdArray() : {}", e.getMessage(), e);
			log.error("getTodayIdArray() : {}", getClass().getName() + " :: getTodayIdArray RuntimeException ========");
		}
...
//		return filterCodeIds;
		if (filterCodeIds != null) {
			return filterCodeIds.clone();
		} else {
			return null;
		}
	}
	...
	public void setFilterCodeIds(String[] filterCodeIds) {
		if (filterCodeIds == null) {
			this.filterCodeIds = null;
		} else {
			this.filterCodeIds = filterCodeIds.clone();
		}
	}
	...
	public void setItemIds(int[] itemIds) {
		if (itemIds == null) {
			...
			int length = itemIds.length;
			this.itemIds = new int[length];
			for (int idx = 0 ; idx < length ; idx++) {
				this.itemIds[idx] = itemIds[idx];
			}
		}
	}
	...
	public String getCategoryLeve2() {
		return categoryLeve2;
	}

	public void setCategoryLeve2(String categoryLeve2) {
		this.categoryLeve2 = categoryLeve2;
	}

	public String getCategoryLeve3() {
		return categoryLeve3;
	}

	public void setCategoryLeve3(String categoryLeve3) {
		this.categoryLeve3 = categoryLeve3;
	}

	public String getCategoryLeve4() {
		return categoryLeve4;
	}

	public void setCategoryLeve4(String categoryLeve4) {
		this.categoryLeve4 = categoryLeve4;
	}
	...
	public String getIsSidoYn() {
		return isSidoYn;
	}

	public void setIsSidoYn(String isSidoYn) {
		this.isSidoYn = isSidoYn;
	}
