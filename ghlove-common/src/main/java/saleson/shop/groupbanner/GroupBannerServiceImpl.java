...
public class GroupBannerServiceImpl extends EgovAbstractServiceImpl implements GroupBannerService {
	...
	private String uploadFile(GroupBanner banner) {
		...
		// 생성.
		try {
			ThumbUtils.create(banner.getUploadFile(), saveFile, banner.getThumbnailWidth(), banner.getThumbnailHeight(), fileStorage);
