...
public class OrderPayment {
	...
	private int itemSequence;			// 주문상품 순번
	...
	public String getApprovalTypeLabel() {
		if (ObjectUtils.isEmpty(this.approvalType)) {
			return "";
		}
	...
	public String getPayInfo() {
		...
		if (ObjectUtils.isEmpty(pgProcInfo) == false) {
...
//									log.error("ERROR: {}", e.getMessage(), e);
									log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException1 ===========");
								}
...
//								log.error("ERROR: {}", e.getMessage(), e);
								log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException2 ===========");
							}
...
//									log.error("ERROR: {}", e.getMessage(), e);
									log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException3 ===========");
								}
...
//								log.error("ERROR: {}", e.getMessage(), e);
								log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException4 ===========");
							}
						}
						...
						if ("card".equals(approvalType)) {	
							...
							if (ValidationUtils.isNull(map.get("CARD_Code")) == false) {
								...
								try {
									...
									log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException5 ===========");
								}
...
//								log.error("ERROR: {}", e.getMessage(), e);
								log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException6 ===========");
							}
...
//									log.error("ERROR: {}", e.getMessage(), e);
									log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException7 ===========");
								}
...
//								log.error("ERROR: {}", e.getMessage(), e);
								log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException8 ===========");
							}
						}
					}
...
//							log.error("ERROR: {}", e.getMessage(), e);
							log.error("ERROR: {}", getClass().getName() + " :: getPayInfo RuntimeException9 ===========");
						}
					}
...
//						}
			...
			if ("bank".equals(getApprovalType())) {
				if (ObjectUtils.isEmpty(getBankVirtualNo()) == false) {
	...
	public String getCardEasyType() {
		return cardEasyType;
	}

	public void setCardEasyType(String cardEasyType) {
		this.cardEasyType = cardEasyType;
	}
