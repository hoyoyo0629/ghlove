...
public class OrderItem {
	...
	private final BaseDataEncryptor encryptor = new BaseDataEncryptor(null);
	...
	private int setDiscountPrice;			// 세트상품 할인금액(율)
	...
	// 세트상품
	private List<OrderItem> itemSets;
	...
	public String getSellerName() {
		return encryptor.decrypt(sellerName);
	}
...
//		return commissionBasePrice;
	...
	public String getUpdateAdminUserName() {
		return encryptor.decrypt(updateAdminUserName);
	}
...
//		return commissionBasePrice * quantity;
	...
	public int getDiscountAmount() {
		return getItemDiscountAmount() + getCouponDiscountAmount() + getUserLevelDiscountAmount() + getSetDiscountAmount();
	}
	...
	public List<OrderItem> getItemSets() {
		return itemSets;
	}

	public void setItemSets(List<OrderItem> itemSets) {
	...
	public int getSetDiscountAmount() {
		return this.setDiscountPrice * quantity;
	}
	...
	private String mobileNumber;	// 	모바일 넘버
	...
	public String getDeliveryShippingUrl() {
		if (StringUtils.hasLength(deliveryCompanyUrl) && StringUtils.hasLength(deliveryNumber)) {
			String value = deliveryCompanyUrl.replace("%INVOICE%", deliveryNumber);
			return value;
		} else {
			return deliveryCompanyUrl;
		}
