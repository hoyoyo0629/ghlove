...
@SequenceGenerator(
	name = "ORDER_LOG_SEQ_GENERATOR"
	, sequenceName = "OP_ORDER_LOG_SEQ"
	, initialValue = 10300000
	, allocationSize = 1)
public class OrderLog extends DateAudit {

	private static final long serialVersionUID = -3458513587847577588L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ORDER_LOG_SEQ_GENERATOR")
	private Long id;
	...
	public String getCreatedAtText() {
		if (ObjectUtils.isEmpty(createdAtText)) {
	...
	public String getUpdatedAtText() {
		if (ObjectUtils.isEmpty(updatedAtText)) {
