...
public class OrderReturnApply {
	...
	private int copySetItemSequence;
	...
	public void setReturnShippingInfo(OrderShippingInfo info) {
		...
		String phone = "";
		if (ObjectUtils.isEmpty(info.getReceivePhone()) == false) {
		...
		String mobile = "";
		if (ObjectUtils.isEmpty(info.getReceiveMobile()) == false) {
	...
	public String getReturnShippingAskType() {
		returnShippingAskType = "2";			// 시스템이 고객 직접 발송 형태라 고정(1: 지정택배사, 2: 직접발송)
	...
	public String getSetClaimCode() {
		return setClaimCode;
	}

	public void setSetClaimCode(String setClaimCode) {
		this.setClaimCode = setClaimCode;
	}
	...
	public int getCopySetItemSequence() {
		return copySetItemSequence;
	}

	public void setCopySetItemSequence(int copySetItemSequence) {
		this.copySetItemSequence = copySetItemSequence;
	}
	...
	// 반품거절 송장정보
	private String rejectShippingDeliveryCompanyId;
	private String rejectShippingDeliveryNumber;
	
	public String getRejectShippingDeliveryCompanyId() {
		return rejectShippingDeliveryCompanyId;
	}
	public void setRejectShippingDeliveryCompanyId(String rejectShippingDeliveryCompanyId) {
		this.rejectShippingDeliveryCompanyId = rejectShippingDeliveryCompanyId;
	}
	public String getRejectShippingDeliveryNumber() {
		return rejectShippingDeliveryNumber;
	}
	public void setRejectShippingDeliveryNumber(String rejectShippingDeliveryNumber) {
		this.rejectShippingDeliveryNumber = rejectShippingDeliveryNumber;
	}
