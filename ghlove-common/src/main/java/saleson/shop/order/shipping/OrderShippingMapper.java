...
public interface OrderShippingMapper {
	 ...
	 * @return
	 */
	List<OrderItem> getBuyShippingCompleteListByParam(OrderParam orderParam);
	 ...
	 * @return
	 */
	int getBuyShippingCompleteListCount(OrderParam orderParam);
	 ...
	 * @return
	 */
	int getNewOrderMobileCountByParam(OrderParam orderParam);
	 ...
	 * @return
	 */
	List<OrderList> getNewOrderMobileListByParam(OrderParam orderParam);
	 ...
	 * @return
	 */
	int getShippingFinishCountByParam(OrderParam orderParam);
	 ...
	 * @return
	 */
	List<OrderList> getShippingFinishListByParam(OrderParam orderParam);
	 ...
	 * @return
	 */
	int updateShippingMobileDirect(ShippingParam shippingParam);
	 ...
	 * @return
	 */
	int updateShppingComplete(OrderParam orderParam);
	 ...
	 * @return
	 */
	int updateOpOrderExchangeApplyClaimStatus(OrderParam orderParam);
	 ...
	 * @return
	 */
	int updateTempShippingMobile(ShippingParam shippingParam);
	 ...
	 * @return
	 */
	Map<String,Object> getSmartDeliveryCode(int deliveryCompanyId);
}
