...
public class OrderGiftItemServiceImpl extends EgovAbstractServiceImpl implements OrderGiftItemService{
    ...
    public void insertOrderGiftItemByByItemId(String orderCode, int orderSequence, int itemSequence, int itemId) {
        ...
        if (!ObjectUtils.isEmpty(orderCode) &&  orderSequence > -1 && itemSequence > -1) {
    ...
    @Override
    public void cancelOrderGiftItem(String orderCode, int orderSequence, int itemSequence) {
        updateGiftOrderStatus(orderCode, orderSequence, itemSequence, GiftOrderStatus.CANCEL);
    }

    @Override
    public void returnOrderGiftItem(String orderCode, int orderSequence, int itemSequence) {
        updateGiftOrderStatus(orderCode, orderSequence, itemSequence, GiftOrderStatus.RETURN);
    }

    private void updateGiftOrderStatus(String orderCode, int orderSequence, int itemSequence, GiftOrderStatus updateGiftOrderStatus) {
    ...
    private List<OrderGiftItem> getOrderGiftItemList(String orderCode, int orderSequence, int itemSequence) {
    ...
    private int getMaxGiftSequence(String orderCode, int orderSequence, int itemSequence) {
