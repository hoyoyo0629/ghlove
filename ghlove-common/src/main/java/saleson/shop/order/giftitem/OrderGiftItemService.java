...
public interface OrderGiftItemService {
     ...
     * @throws Exception
     */
    void cancelOrderGiftItem(String orderCode, int orderSequence, int itemSequence);
     ...
     * @throws Exception
     */
    void returnOrderGiftItem(String orderCode, int orderSequence, int itemSequence);
