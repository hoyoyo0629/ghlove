...
public class ConfigPgServiceImpl extends EgovAbstractServiceImpl implements ConfigPgService{
    ...
    public boolean isDisplayNaverPayFlag() {
        ConfigPg configPg = getConfigPg();

        if (configPg != null) {
            return configPg.isUseNpayOrder();
        }
