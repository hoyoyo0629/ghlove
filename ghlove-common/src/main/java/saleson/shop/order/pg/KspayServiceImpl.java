...
public class KspayServiceImpl extends EgovAbstractServiceImpl implements PgService {
...
//		String	d =  request.getParameter("d");
		...
		if (ipg.kspay_send_msg("1"))		//KSNET 결제결과 중 아래에 나타나지 않은 항목이 필요한 경우 Null 대신 필요한 항목명을 설정할 수 있습니다.
		{
			...
			if (authno != null && null != authyn && 1 == authyn.length())
			{
				if (authyn.equals("O"))
				{
					resultcd = "0000";
				...
				{
					resultcd = CommonUtils.dataNvl(authno.trim()) ;
				}
