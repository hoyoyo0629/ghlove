...
public class BuyProduct {
	...
	public BuyProduct(BuyItem buyItem, String cpId, String productId, int sortOrdering) {
		...
		this.productName = CommonUtils.dataNvl(buyItem.getItemName());
		this.sellerOrderProductReferenceKey = buyItem.getItemUserCode();
		if(itemPrice != null) {
			this.productAmt =  CommonUtils.intNvl(itemPrice.getSaleAmount());
			this.productPaymentAmt = CommonUtils.intNvl(itemPrice.getSaleAmount());
