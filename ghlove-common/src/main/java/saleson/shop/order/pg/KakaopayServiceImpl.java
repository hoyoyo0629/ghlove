...
public class KakaopayServiceImpl extends EgovAbstractServiceImpl implements PgService, KakaopayInfoService {
	...
	public HashMap<String, Object> init(Object data, HttpSession session) {
	    ...
	    try {
			...
			log.error("kakaopay init(..) RuntimeException");
			throw new OrderException(e.getErrorMessage());
		} catch (Exception e) {
			log.error("kakaopay init(..) Exception");
...
//			log.error("KakaopayServiceImpl : {}", e.getMessage(), e);
			log.error("KakaopayServiceImpl : {}", getClass().getName() + " :: init RuntimeException2 ===========");
		} catch (Exception e) {
//			log.error("KakaopayServiceImpl : {}", e.getMessage(), e);
			log.error("KakaopayServiceImpl : {}", getClass().getName() + " :: init Exception2 ===========");
		}
	...
	public class DataEncrypt {
		...
		public String encrypt(String strData) { // 암호화 시킬 데이터
			try {
				MessageDigest md = MessageDigest.getInstance("SHA-256"); // "MD5 형식으로 암호화"
				md.reset();
			   ...
			   log.error("암호화 에러: {}", getClass().getName() + " :: encrypt NoSuchAlgorithmException ============");
		   }
		...
		public String SHA256(String strData) { // 암호화 시킬 데이터
			...
			try{
			   ...
			   log.error("암호화 에러: {}", getClass().getName() + " :: SHA256 NoSuchAlgorithmException ============");
				SHA = null;
			}
			return SHA;
		}
	...
	public String SHA256Salt(String strData, String salt) { 
		...
		try {
			...
			log.error("암호화 에러: {}", getClass().getName() + " :: SHA256Salt NoSuchAlgorithmException ============");
			SHA = null;
		}
