...
public class EasypayServiceImpl extends EgovAbstractServiceImpl implements PgService {
	...
	public OrderPgData pay(Object data, HttpSession session) {
		...
		if ( res_cd.equals("0000") ) {
			...
			orderPgData.setPartCancelFlag(ObjectUtils.isEmpty(r_part_cancel_yn) ? "N" : r_part_cancel_yn);
			orderPgData.setPartCancelDetail("");
