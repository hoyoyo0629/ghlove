...
public class PopbillServiceImpl extends EgovAbstractServiceImpl implements PopbillService {
...
//            result.setResponseMessage(MessageUtils.getMessage("실패했습니다."));			// 실패했습니다.
            if (e.getCode() == -99999999) {
            	result.setResponseMessage("현금영수증정보가 입력되지 않았습니다.");			// 실패했습니다.
            } else {
                result.setResponseMessage("실패했습니다.");			// 실패했습니다.
            }
        }
...
//            result.setResponseMessage(MessageUtils.getMessage("실패했습니다."));			// 실패했습니다.
            if (e.getCode() == -99999999) {
            	result.setResponseMessage("관리번호가 입력되지 않았습니다.");			// 실패했습니다.
            } else {
                result.setResponseMessage("실패했습니다.");			// 실패했습니다.
            }
            result.setSuccess(false);
...
//            result.setResponseMessage(MessageUtils.getMessage("실패했습니다."));			// 실패했습니다.
            if (e.getCode() == -99999999) {
            	result.setResponseMessage("취소현금영수증 문서관리번호가 입력되지 않았습니다.");			// 실패했습니다.
            } else {
                result.setResponseMessage("실패했습니다.");			// 실패했습니다.
            }
            result.setSuccess(false);
