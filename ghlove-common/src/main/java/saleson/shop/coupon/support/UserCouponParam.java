...
public class UserCouponParam extends SearchParam {
	...
	public String[] getCouponTargetUserLevels() {
		if (couponTargetUserLevels == null) {
			return null;
		} else {
			return couponTargetUserLevels.clone();
		}
	}

	public void setCouponTargetUserLevels(String[] couponTargetUserLevels) {
		if (couponTargetUserLevels == null) {
			this.couponTargetUserLevels = null;
		} else {
			this.couponTargetUserLevels = couponTargetUserLevels.clone();
		}
	}
}
