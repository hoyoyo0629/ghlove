...
public class CouponTargetItem {
	...
	public String getCategoryClass() {
		...
		if (ObjectUtils.isEmpty(this.categoryClass) == false) {
			return this.categoryClass;
		}
		
		if (ObjectUtils.isEmpty(this.categoryClass4) == false) {
			return this.categoryClass4;
			
		} else if (ObjectUtils.isEmpty(this.categoryClass3) == false) {
			return this.categoryClass3;
			
		} else if (ObjectUtils.isEmpty(this.categoryClass2) == false) {
			return this.categoryClass2;
			
		} else if (ObjectUtils.isEmpty(this.categoryClass1) == false) {
