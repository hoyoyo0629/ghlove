...
public class FeaturedParam extends SearchParam{
	...
	private int notFeaturedId;			// 본인 이벤트 아이디 검색 제외시킬 경우(중복 체크 조회)

	private String ingCond;			// 진행중 이벤트 여부	// srhan. 20250825
	...
	public int getNotFeaturedId() {
		return notFeaturedId;
	}
	public void setNotFeaturedId(int notFeaturedId) {
		this.notFeaturedId = notFeaturedId;
	}
	public String getIngCond() {
		return ingCond;
	}
	public void setIngCond(String ingCond) {
		this.ingCond = ingCond;
	}
