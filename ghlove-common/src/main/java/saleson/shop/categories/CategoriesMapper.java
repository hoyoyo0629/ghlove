...
public interface CategoriesMapper {
	...
	void saveCategoryGroupIdByParam(CategoriesSearchParam categoriesSearchParam);
	 ...
	 */
	@CacheEvict(value = "frontCategories", allEntries=true)
	void removeCategoryGroupIdByParam(CategoriesSearchParam categoriesSearchParam);
	 ...
	 * @return
	 */
	List<Categories> getChildCategoriesFromParentCategoryClass(String categoryClass);
	 ...
	 * @return
	 */
	Categories getCategoryLevelClassByCategoryParam(CategoryParam categoryParam);

	/**
	 * Sitemap용 카테고리 정보 조회
	 * @return
	 */
	List<CategoryPath> getCategoryPath(CategoryParam categoryParam);
}
