...
public interface CategoriesService {
	 ...
	 * @return
	 */
	public List<Categories> getChildCategoriesFromParentCategoryClass(String categoryClass);
	 ...
	 * 카테고리 경로 (그룹/1차/2차/3차)
	 * @param breadcrumbs
	 * @param displayGroupFlag
	 * @return
	 */
	String getCategoryPathByBreadcrumbs(List<Breadcrumb> breadcrumbs, boolean displayGroupFlag);
