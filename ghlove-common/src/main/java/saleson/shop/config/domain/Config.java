...
public class Config {
	...
	public String getPost() {
		...
		if (ObjectUtils.isEmpty(this.post2)) {
			return post;
		}
	...
	public String getSmartDeliveryCriteriaDate() {
		return smartDeliveryCriteriaDate;
	}

	public void setSmartDeliveryCriteriaDate(String smartDeliveryCriteriaDate) {
		this.smartDeliveryCriteriaDate = smartDeliveryCriteriaDate;
	}
