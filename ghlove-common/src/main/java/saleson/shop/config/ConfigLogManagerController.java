...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", getClass().getName() + " :: configLogs RuntimeException ============");
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", getClass().getName() + " :: configLogsByLogType RuntimeException ============");
            httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
            configLogs = null;
        }
        return new ResponseEntity<>(configLogs, httpStatus);
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", getClass().getName() + " :: insertConfigLog RuntimeException ============");
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", getClass().getName() + " :: updateConfigLog RuntimeException ============");
