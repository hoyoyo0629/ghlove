...
public class CampaignDto extends Param {
    ...
    public Predicate getSendPredicate() {
        ...
        if (!ObjectUtils.isEmpty(getBatchDateTime())) {
    ...
    public Predicate getPredicate() {
        ...
        if (!ObjectUtils.isEmpty(getMessageType())) {
            builder.and(campaign.messageType.eq(messageType));
        }

        if (!ObjectUtils.isEmpty(getSendType())) {
            builder.and(campaign.sendType.eq(sendType));
        }

        if (!ObjectUtils.isEmpty(getAutoMonth())) {
        ...
        if (!ObjectUtils.isEmpty(getStartSentDate())) {
            builder.andAnyOf(
        ...
        if (!ObjectUtils.isEmpty(getEndSentDate())) {
            builder.andAnyOf(
