...
public interface CampaignService {
     ...
     * @throws Exception
     */
    void insertCampaign(Campaign campaign, CampaignUserParam campaignUserParam);
     ...
     * @throws Exception
     */
    void insertCampaignUser(Long campaignId, CampaignUserParam campaignUserParam, String sendType);
    ...
    void insertCampaignMessageBatch();

    void publishCouponByCampaign(Campaign campaign);

    List<Map<String, Object>> getUserApplicationInfo(CampaignUserParam campaignUserParam);

    void updateCampaign(Long campaignId, Campaign campaign, CampaignUserParam campaignUserParam, String status);
