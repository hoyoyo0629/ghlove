...
public interface CampaignRepository extends JpaRepository<Campaign, Long>, QuerydslPredicateExecutor<Campaign> {
    ...
    @Transactional
    @Modifying
    @Query(value = CampaignQueryConst.DELETE_SMS_LOG_TEMP, nativeQuery = true)
    void deleteSmsLogTemp();

    @Transactional
    @Modifying
    @Query(value = CampaignQueryConst.DELETE_MMS_LOG_TEMP, nativeQuery = true)
    void deleteMmsLogTemp();

    @Transactional
    @Modifying
    @Query(value = CampaignQueryConst.DELETE_PUSH_LOG_TEMP, nativeQuery = true)
    void deletePushLogTemp();

    @Transactional
    @Modifying
    @Query(value = CampaignQueryConst.DELETE_KAKAO_LOG_TEMP, nativeQuery = true)
    void deleteKakaoLogTemp();
