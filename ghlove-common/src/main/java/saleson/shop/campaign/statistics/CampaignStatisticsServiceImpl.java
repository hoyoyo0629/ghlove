...
public class CampaignStatisticsServiceImpl extends EgovAbstractServiceImpl implements CampaignStatisticsService{
    ...
    @Override
    public void updateCampaignSentBatch(String batchDate, Campaign campaign) {
...
//                logger.error("updateSent Error [{}] {}", key, e.getMessage(), e);
                logger.error("updateSent Error [{}] {}", key, getClass().getName() + " :: updateCampaignSentBatch RuntimeException ===========");
            }
        }
    ...
    @Override
    public void updateCampaignSentBatchStep2(String batchDate) {
        String statisticsDate = DateUtils.getToday(Const.DATETIME_FORMAT);
        ...
        try {
            ...
            // 유정 통계 업데이트
            updateRedirection(batchDate, statisticsDate);
        } catch (RuntimeException e) {	// 시큐어 코딩 점검 수정 (2023.12.21)
//            logger.error("updateCampaignSentBatchStep2 Error [{}] {}", e.getMessage(), e);
            logger.error("updateCampaignSentBatchStep2 Error [{}] {}", getClass().getName() + " :: updateCampaignSentBatchStep2 RuntimeException ===========");
        }

    }

    @Override
    public void updateCampaignSentBatchStep3(String batchDate) {
        String statisticsDate = DateUtils.getToday(Const.DATETIME_FORMAT);
...
//            logger.error("updateCampaignSentBatchStep5 Error [{}] {}", e.getMessage(), e);
            logger.error("updateCampaignSentBatchStep3 Error [{}] {}", getClass().getName() + " :: updateCampaignSentBatchStep3 RuntimeException ===========", e);
        }
    }


    private String getId() {
        return environment.getProperty("ums.client-id");
    }
...
//            logger.error("getUmsSendInfos error {}",e.getMessage(), e);
            logger.error("getUmsSendInfos Error [{}] {}", getClass().getName() + " :: getUmsSendInfos RuntimeException ===========", e);
...
//            logger.error("setStatisticsInfoMap error {}",e.getMessage(), e);
            logger.error("setStatisticsInfoMap Error [{}] {}", getClass().getName() + " :: setStatisticsInfoMap RuntimeException ===========", e);
        }
    }
...
//                    logger.error("updateRedirection error [{}] {}", id, e.getMessage(), e);
                    logger.error("updateRedirection Error [{}] {}", id, getClass().getName() + " :: updateRedirection RuntimeException1 ===========", e);
                }
            }
...
//                logger.error("updateRedirection Error [{}] {}", key, e.getMessage(), e);
                logger.error("updateRedirection Error [{}] {}", key, getClass().getName() + " :: updateRedirection RuntimeException2 ===========", e);
            }
        }
    }
...
//                    logger.error("updateOrderInfo not CampaignId [{}] {}", id, e.getMessage(), e);
                    logger.error("updateOrderInfo Error [{}] {}", id, getClass().getName() + " :: updateOrderInfo RuntimeException1 ===========", e);
                }
            }
        }
...
//                logger.error("updateOrderInfo Error [{}] {}", key, e.getMessage(), e);
                logger.error("updateOrderInfo Error [{}] {}", key, getClass().getName() + " :: updateOrderInfo RuntimeException2 ===========", e);
            }
        }
    }
    ...
    @Override
    public Campaign getAutoMonthCampaign(String batchDate) {
    ...
    @Override
    public void insertSentForUser(String sentType, List<String> tables) {
    ...
    @Override
    public void insertAutoSentForUser(String sentType, List<String> tables, Campaign campaign) {
...
//                    logger.error("setStatisticsInfoMapForUser Error [{}] {}", param, e.getMessage(), e);
                    logger.error("setStatisticsInfoMapForUser Error [{}] {}", param, getClass().getName() + " :: setStatisticsInfoMapForUser RuntimeException ===========", e);
                }
            }
...
//            logger.error("setStatisticsInfoMapForUser Error [{}] {}", param, e.getMessage(), e);
            logger.error("setStatisticsInfoMapForUser3 Error [{}] {}", param, getClass().getName() + " :: setStatisticsInfoMapForUser RuntimeException3 ===========", e);
        }
...
//            logger.error("updateCampaignUser Error [{}] {}", e);
            logger.error("updateCampaignUser Error [{}] {}", getClass().getName() + " :: updateCampaignUser RuntimeException3 ===========", e);
        }
    }
...
//                    logger.error("updateOrderInfo Error [{}] {}", s.getKey(), e.getMessage(), e);
                    logger.error("updateOrderInfoForUser Error [{}] {}", getClass().getName() + " :: updateOrderInfoForUser RuntimeException3 ===========", e);
                }
            }
        }
...
//            logger.error("getUserList error {}", e.getMessage(), e);
            logger.error("getUserList Error [{}] {}", getClass().getName() + " :: getUserList RuntimeException3 ===========", e);
            return null;
        }
    }
}
