...
public interface CampaignRegularService {
     ...
     * @throws Exception
     */
    void insertCampaignRegular(CampaignRegular campaignRegular);
     ...
     * @throws Exception
     */
    void updateCampaignRegular(Long campaignRegularId, CampaignRegular campaignRegular, CampaignUserParam campaignUserParam, String status);
     ...
     * @throws Exception
     */
    void deleteCampaignRegular(Long id);
}
