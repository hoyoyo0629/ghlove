...
public interface UserMapper {
	 ...
	 * @return
	 */
	int getUserCountByManagerPhoneNumber(String phoneNumber);
	 ...
	 * @param userDetail
	 */
	void insertUserBirthday(UserDetail userDetail);
	 ...
	 * @param user
	 */
	int updateUserByLoginId(User user);
	 ...
	 * @return
	 */
	Integer confirmUserPassword(User user);
	 ...
	 * @return
	 */
	List<UserRole> getManagerRoleListByLoginId(String loginId);
	 ...
	 * @param user
	 */
	void insertChargerManager(Manager manager);
	 ...
	 * @param user
	 */
	int updatePasswordExpiredDateForManager(User user);
	 ...
	 * 사용되지 않는 사용자 잠금처리
	 */
	void updateLockForManager(int unusedDays);
	 ...
	 * @return
	 */
	String getAuthExpiredDateById(long userId);

	/**
	 * 관리자 본인 인증 시간 업데이트
	 * @param userId
	 */
	void updateAuthExpiredDateById(Map<String, Object> map);
	 ...
	 * @return
	 */
	int deleteIntrstLocgov(long userId);

	/**
	 * 마이페이지 > 회원정보 정보 수정(프론트)
	 * @param user
	 * @return
	 */
	 ...
	 * @return
	 */
	void updateUserEtcInfo(UserDetail userDetail);
	 ...
	 * @return
	 */
	int updateUserDetailInfo(UserDetail userDetail);
	 ...
	 * @return
	 */
	User getUserByNoLoginUser(ChangePasswordForNoLoginUser changePassword);

	/**
	 * 비로그인 시 비밀번호 변경 관리자에서 설정한 비밀번호
	 * @param changePassword
	 * @return
	 */
	int changeUserPasswordLater(ChangePasswordForNoLoginUser changePassword);
	 ...
	 * @return
	 */
	String getUserKeyInfo(long user);
	 ...
	 * @return
	 */
	String getUserLoginPathInfo(long user);
	...
	/**
	 * 회원정보 수정 시 관리자 정보도 같이 업데이트
	 * @param opmanagerParam
	 * @return
	 */
	int updateManagerInfo(OpManagerParam opmanagerParam);

	/**
	 * 본인인증 시 생년월일, 성별정보 업데이트
	 * @param opmanagerParam
	 * @return
	 */
	int modifyMobileAuthDetail(AuthInfo authInfo);
	 ...
	 * @return
	 */
	PkiManagerLogin getPkiManagerFormValid(PkiManagerLogin pkiManagerLogin);
	 ...
	 * @return
	 */
	PkiManagerLogin getPkiManagerFormValidOff(PkiManagerLogin pkiManagerLogin);
	 ...
	 * @return
	 */
	int updatePkiManagerMberDn(PkiManagerLogin pkiManagerLogin);
	 ...
	 * @return
	 */
	int updatePkiManagerMberFinDn(PkiManagerLogin pkiManagerLogin);
	 ...
	 * @return
	 */
	int deletePkiManagerMberDn(PkiManagerLogin pkiManagerLogin);
	 ...
	 * @return
	 */
	int deletePkiManagerMberFinDn(PkiManagerLogin pkiManagerLogin);

	/**
	 * 인증서 등록을 위한 회원 정보 조회(사용자)
	 * @param signInfo
	 * @return
	 */
	SignInfo getUserForSignRegister(SignInfo signInfo);
	 ...
	 * @return
	 */
	int updateUserSignRegister(SignInfo signInfo);
	 ...
	 * @return
	 */
	int signRemoveForUser(SignInfo signInfo);
	...
	/**
	 * 회원 DN 정보로 회원 정보 조회 (단건)
	 * @param mberDn
	 * @return
	 */
	User getUserByMberDn(String mberDn);

	/**
	 * 회원 DN 정보로 회원 정보 조회 (단건) / 금융인증서
	 * @param mberFinDn(mberDn)
	 * @return
	 */
	User getUserByMberFinDn(String mberFinDn);
	 ...
	 * @return
	 */
	User getUserByMberCi(String mberCi);
	 ...
	 * @return
	 */
	List<User> getUserListByMberDn(String mberDn);

	/**
	 * 회원 FIN(DN) 정보로 회원 정보 조회
	 * @param mberDn
	 * @return
	 */
	List<User> getUserListByMberFinDn(String mberFinDn);
	...
	String getLoginId(@Param("mberType") String mberType, @Param("mberValue") String mberValue);
	...
	List<HashMap<String, Object>> getUserBirthdayDecList();

	void deleteUserBirthdayDec();

	void deleteUserBirthdayAndUserId(Long userId);

//	void insertUserBirthdayDec(HashMap<String, Object> hashMap);

	void insertUserBirthdayDec(List<HashMap<String, Object>> param);
	...
	List<HashMap<String, Object>> getOpUserBirthdayDecSubstrList();

	List<HashMap<String, Object>> getOpUserBirthdayDecListParam(HashMap<String, Object> hashMap);

	List<HashMap<String, Object>> getOpUserBirthdayAllList(String str);
	 ...
	 * @return
	 */
	List<String> getSleepManagerTarget();
