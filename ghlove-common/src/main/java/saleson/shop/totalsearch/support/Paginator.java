...
public class Paginator {
    ...
    private HashMap<String, Object> getBlock(Integer currentPageNum,
                                         Boolean isFixed) {
        ...
        result.put("blockLastPageNum", (blockLastPageNum+1));
        result.put("blockFirstPageNum", (blockFirstPageNum-1));
        ...
        result.put("nextPage", result.get("blockLastPageNum"));

        return result;
    }

    public HashMap<String, Object> getElasticBlock(Integer currentPageNum) {
        return this.getBlock(currentPageNum, false);
    }

    public HashMap<String, Object> getFixedBlock(Integer currentPageNum) {
