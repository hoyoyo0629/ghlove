...
public interface CategoriesFilterService {
     ...
     * @throws Exception
     */
    void saveFilter(FilterGroup filterGroup, List<FilterCode> newCodeList);

    /**
     * 카테고리 필터 삭제
     * @param idArray
     */
    void deleteFilter(String[] idArray);
     ...
     */
    void saveCategoriesFilter(int categoryId, Set<Long> filterGroupIdSet);
     ...
     * @param filterCodes
     */
    void saveItemFilter(int itemId, Map<String, List<String>> filterCodes);
