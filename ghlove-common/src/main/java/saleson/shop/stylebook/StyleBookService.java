...
public interface StyleBookService {
     ...
     * @param styleBook
     */
    void insertStyleBook(StyleBook styleBook) throws IOException;

    /**
     * 스타일북 수정
     * @param styleBook
     */
    void updateStyleBook(StyleBook styleBook) throws IOException;

    /**
     * 스타일북 삭제
     * @param id
     */
    void deleteStyleBookById(long id) throws IOException;
     ...
     * @param listParam
     */
    void deleteStyleBookByIds(ListParam listParam);
}
