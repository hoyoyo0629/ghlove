...
public class BaseStats {
    ...
    public long getDiscountAmount() {
        return (this.couponDiscountPrice + this.sellerDiscountPrice + this.spotDiscountPrice + this.userLevelDiscountPrice + this.setDiscountPrice);
    }

    public long getCancelDiscountAmount() {
        return (this.cancelCouponDiscountPrice + this.cancelSellerDiscountPrice + this.cancelSpotDiscountPrice + this.cancelUserLevelDiscountPrice + this.cancelSetDiscountPrice);
    }
    ...
    public long getSetDiscountPrice() {
        return setDiscountPrice;
    }

    public void setSetDiscountPrice(long setDiscountPrice) {
        this.setDiscountPrice = setDiscountPrice;
    }

    public long getCancelSetDiscountPrice() {
        return cancelSetDiscountPrice;
    }

    public void setCancelSetDiscountPrice(long cancelSetDiscountPrice) {
