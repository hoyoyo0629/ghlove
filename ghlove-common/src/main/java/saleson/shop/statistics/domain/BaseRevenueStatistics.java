...
public class BaseRevenueStatistics {
	...
	private double setDiscount;					// 세트 할인
	private double cancelSetDiscount;
	...
	public double getPayDiscountTotal() {
		return ShopUtils.statsNegativeNnumber(couponDiscount + spotDiscount + sellerDiscount + userLevelDiscount + setDiscount);
	}
	
	// 취소 할인 총액 
	public double getCancelDiscountTotal() {
		return cancelCouponDiscount + cancelSpotDiscount + cancelSellerDiscount + cancelUserLevelDiscount + cancelSetDiscount;
	}
	...
	public double getCancelSetDiscount() {
		return cancelSetDiscount;
	}

	public void setCancelSetDiscount(double cancelSetDiscount) {
		this.cancelSetDiscount = cancelSetDiscount;
	}
}