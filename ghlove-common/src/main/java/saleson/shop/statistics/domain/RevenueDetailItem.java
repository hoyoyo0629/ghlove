...
public class RevenueDetailItem {
	...
	private String openMarketOption;
	...
	public String getOpenMarketOption() {
		return openMarketOption;
	}

	public void setOpenMarketOption(String openMarketOption) {
		this.openMarketOption = openMarketOption;
	}
