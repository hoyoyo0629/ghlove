...
public class ShopStatisticsLocgovExcelView extends AbstractSXSSFExcelView{

	private List<DateStatsSummary> list;

	public ShopStatisticsLocgovExcelView() {
	...
	private void buildItemSheet(SXSSFWorkbook workbook, List<DateStatsSummary> list) {
		...
		for(DateStatsSummary obj : list){
			for(BaseStats obj2 : obj.getGroupStats()){
				...
				setText(sheet, 			rowIndex, cellIndex, String.valueOf(obj2.getItemName()));
				setText(sheet, 			rowIndex, cellIndex, String.valueOf(obj2.getCompanyName()));
