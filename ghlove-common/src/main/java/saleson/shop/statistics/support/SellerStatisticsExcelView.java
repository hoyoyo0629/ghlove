	...
	private void buildUserSheet(SXSSFWorkbook workbook, List<SellerStatsSummary> list) {
		...
		for (SellerStatsSummary seller : list) {
			...
			for(BaseStats item : seller.getGroupStats()){
				...
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getSaleCount())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getItemPrice())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getDiscountAmount())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getSaleAmount())));

				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getCancelCount())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getCancelItemPrice())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getCancelDiscountAmount())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getCancelAmount())));

				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getTotalCount())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getTotalItemPrice())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getTotalDiscountAmount())));
				setTextRight(sheet, rowIndex, cellIndex, StringUtils.numberFormat(String.valueOf(item.getTotalAmount())));
