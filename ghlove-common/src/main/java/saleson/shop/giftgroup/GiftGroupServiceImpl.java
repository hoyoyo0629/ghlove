...
public class GiftGroupServiceImpl extends EgovAbstractServiceImpl implements GiftGroupService {
    ...
    @Override
    public void insertGiftGroup(GiftGroup giftGroup) {
    ...
    @Override
    public void deleteGiftGroup(ListParam listParam) {
    ...
    @Override
    public GiftGroup getGiftGroupById(long id) {
    ...
    @Override
    public Page<GiftGroup> getGiftGroupList(Predicate predicate, Pageable pageable) {
