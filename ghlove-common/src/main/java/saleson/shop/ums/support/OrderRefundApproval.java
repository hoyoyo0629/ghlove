...
public class OrderRefundApproval extends UmsTemplate {
    ...
    public OrderRefundApproval(Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public OrderRefundApproval(Ums ums, OrderRefund orderRefund, long userId, Config config, String phoneNumber, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
