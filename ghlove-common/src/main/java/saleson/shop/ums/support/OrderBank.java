...
public class OrderBank extends UmsTemplate {
    ...
    public OrderBank(Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public OrderBank(Ums ums, Order order, OrderPayment orderPayment, long userId, Config config, String phoneNumber, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
    ...
    public OrderBank(Ums ums, Buy buy, BuyPayment buyPayment, long userId, Config config, String phoneNumber, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
        super(ums, phoneNumber, cryptor, dataMasking);
        ...
        if (buy.getItems() != null && !buy.getItems().isEmpty()) {
    ...
    private void intiCodeMap() {
        ...
        map.put("user_name", getDataMasking().mask(getCryptor().decrypt(this.orderName), Masking.NAME));
