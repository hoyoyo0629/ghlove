...
public class ConfirmPurchaseRequest extends UmsTemplate {
    ...
    public ConfirmPurchaseRequest(Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public ConfirmPurchaseRequest(Ums ums, long userId, String phoneNumber, Config config, ApplicationInfo applicationInfo, Cryptor cryptor) {
