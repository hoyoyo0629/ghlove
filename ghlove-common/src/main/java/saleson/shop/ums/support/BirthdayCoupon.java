...
public class BirthdayCoupon extends UmsTemplate {
    ...
    public BirthdayCoupon(Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public BirthdayCoupon(Ums ums, CouponUser couponUser, long userId, String phoneNumber, Config config, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
