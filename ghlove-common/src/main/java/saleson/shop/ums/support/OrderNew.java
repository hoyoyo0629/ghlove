...
public class OrderNew extends UmsTemplate {
    ...
    public OrderNew(Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public OrderNew(String orderName, Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public OrderNew(Ums ums, Order order, long userId, Config config, String phoneNumber, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
    ...
    public OrderNew(Ums ums, Buy buy, long userId, Config config, String phoneNumber, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
        super(ums, phoneNumber, cryptor, dataMasking);
