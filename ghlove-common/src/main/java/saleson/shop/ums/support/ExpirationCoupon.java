...
public class ExpirationCoupon extends UmsTemplate {
    ...
    public ExpirationCoupon(Cryptor cryptor) {
        super(cryptor);
        intiCodeMapView();
    }

    public ExpirationCoupon(Ums ums, CouponUser couponUser, long userId, String phoneNumber, Config config, ApplicationInfo applicationInfo, Cryptor cryptor, DataMasking dataMasking) {
