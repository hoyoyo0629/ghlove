...
public interface AlimTalkService {
     ...
     * @return
     */
    AlimTalkTemplate getTemplate(String applyCode) throws RuntimeException;

    /**
     * 알림톡 템플릿 목록 조회
     * @return
     */
    List<AlimTalkTemplate> getTemplateList() throws RuntimeException;

    /**
     * 알림톡 템플릿 등록
     * @param alimTalkTemplate
     */
    void registerTemplate(AlimTalkTemplate alimTalkTemplate) throws RuntimeException;

    /**
     * 알림톡 템플릿 수정
     * @param alimTalkTemplate
     */
    void editTemplate(AlimTalkTemplate alimTalkTemplate) throws RuntimeException;

    /**
     * 알림톡 템플릿 삭제
     * @param applyCode
     */
    void deleteTemplate(String applyCode) throws RuntimeException;

    /**
     * 알림톡 템플릿 검수 확인
     * @param applyCode
     */
    void verifyTemplate(String applyCode) throws RuntimeException;
