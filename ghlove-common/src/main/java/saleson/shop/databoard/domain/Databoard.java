...
public class Databoard {
	...
	List<DataboardFile> databoardFiles = new ArrayList<>();
	...
	public List<DataboardFile> getDataboardFiles() {
		return databoardFiles;
	}
	public void setDataboardFiles(List<DataboardFile> databoardFiles) {
		this.databoardFiles = databoardFiles;
	}
