...
public class OffgiveExcelView extends AbstractSXSSFExcelView{

	private List<Offgive> list;

	public OffgiveExcelView() {

		setFileName("OFFGIVE_" + DateUtils.getToday(Const.DATETIME_FORMAT) + ".xlsx");
	}
