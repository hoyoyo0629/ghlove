...
public class Qna extends SearchParam {
	...
	public List<QnaOpenFile> getQnaOpenFileList() {
		if (qnaOpenFileList == null) {
			return null;
		} else {
			List<QnaOpenFile> copyList = new ArrayList<>();
			for (QnaOpenFile qnaOpenFile : qnaOpenFileList) {
				try {
					copyList.add((QnaOpenFile) qnaOpenFile.clone());
	...
	public void setQnaOpenFileList(List<QnaOpenFile> qnaOpenFileList) {
		if (qnaOpenFileList == null) {
			this.qnaOpenFileList = null;
		} else {
			this.qnaOpenFileList = new ArrayList<>();
			for (QnaOpenFile qnaOpenFile : qnaOpenFileList) {
				try {
					this.qnaOpenFileList.add((QnaOpenFile) qnaOpenFile.clone());
				} catch (CloneNotSupportedException e) {
					continue;
				}
			}
	...
	public List<QnaOpenFile> getQnaOpenAnswerFileList() {
		if (qnaOpenAnswerFileList == null) {
			return null;
		} else {
			List<QnaOpenFile> copyList = new ArrayList<>();
			for (QnaOpenFile qnaOpenAnswerFile : qnaOpenAnswerFileList) {
				try {
					copyList.add((QnaOpenFile) qnaOpenAnswerFile.clone());
				} catch (CloneNotSupportedException e) {
					continue;
				}
			}
	...
	public void setQnaOpenAnswerFileList(List<QnaOpenFile> qnaOpenAnswerFileList) {
		if (qnaOpenAnswerFileList == null) {
			this.qnaOpenAnswerFileList = null;
		} else {
			this.qnaOpenAnswerFileList = new ArrayList<>();
			for (QnaOpenFile qnaOpenAnswerFile : qnaOpenAnswerFileList) {
				try {
					this.qnaOpenAnswerFileList.add((QnaOpenFile) qnaOpenAnswerFile.clone());
				} catch (CloneNotSupportedException e) {
					continue;
				}
			}
