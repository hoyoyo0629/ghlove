...
public class Policy {
     ...
     * 저작권 정책
     */
    public final static String POLICY_TYPE_COPYRIGHT = "5";
    ...
    public String getPolicyTypeLabel() {
        if (ObjectUtils.isEmpty(this.policyType)) {
            return "";
        }
        ...
        } else if ("4".equals(this.policyType)) {
        	fileTypeName = "개인정보제3자동의";
        } else if ("5".equals(this.policyType)) {
        	fileTypeName = "저작권정책";
        }
