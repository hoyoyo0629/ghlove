package saleson.shop.menu.domain;
...
public class Menu {
	...
	public String getMenuPageContent() {
		return menuPageContent;
	}
	public void setMenuPageContent(String menuPageContent) {
		this.menuPageContent = menuPageContent;
	}
