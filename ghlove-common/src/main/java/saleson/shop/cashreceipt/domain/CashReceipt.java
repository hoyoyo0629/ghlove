...
public class CashReceipt {
	...
	public String getCashReceiptCode() {
		...
		if ("1".equals(this.cashReceiptType)) {
			...
			if (ObjectUtils.isEmpty(this.cashReceiptBusinessNumber1)) isAppCashReceipts = false;
			if (ObjectUtils.isEmpty(this.cashReceiptBusinessNumber2)) isAppCashReceipts = false;
			if (ObjectUtils.isEmpty(this.cashReceiptBusinessNumber3)) isAppCashReceipts = false;
			...
			if (ObjectUtils.isEmpty(this.cashReceiptPhone1)) isAppCashReceipts = false;
			if (ObjectUtils.isEmpty(this.cashReceiptPhone2)) isAppCashReceipts = false;
			if (ObjectUtils.isEmpty(this.cashReceiptPhone3)) isAppCashReceipts = false;
	...
	public String getCashReceiptType() {
		if (ObjectUtils.isEmpty(cashReceiptType)) {
			return "0";
		} else {
			if (ObjectUtils.isEmpty(this.getCashReceiptCode())) {
