function createSEditor2(elIRField, htParams, elSeAppContainer){
	...
	*/
	...
	// SKC (CTP 업로드)
	//oEditor.registerPlugin(new nhn.husky.SE2M_CTP(elAppContainer)); // CTP
	oEditor.registerPlugin(new nhn.husky.SE2M_MOVIE(elAppContainer)); // MOVIE
	...
	oEditor.registerPlugin(new nhn.husky.SE2M_Hyperlink(elAppContainer));			// URL 링크 - 운영사업단 요청으로 추가 - 2023.06.19.
