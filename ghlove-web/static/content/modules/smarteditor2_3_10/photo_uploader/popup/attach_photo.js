	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/smarteditor/upload-image',	//샘플 URL입니다.location.href.replace(/\/[^\/]*$/, '') + '/smarteditor/upload'
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	    	/*
 	    	sFiletype : "*.jpg;*.png;*.bmp;*.gif",						//허용할 파일의 형식. ex) "*", "*.*", "*.jpg", 구분자(;)
 	    	sMsgNotAllowedExt : 'JPG, GIF, PNG, BMP 확장자만 가능합니다',	//허용할 파일의 형식이 아닌경우에 띄워주는 경고창의 문구
 	    	*/
 	    	// 스마트 에디터 업로드 화면에 정의된 파일 형식으로 수정
 	    	sFiletype : "*.jpg;*.jpeg;*.gif;*.png",						//허용할 파일의 형식. ex) "*", "*.*", "*.jpg", 구분자(;)
 	    	sMsgNotAllowedExt : 'jpg, jpeg, gif, png 확장자만 가능합니다',	//허용할 파일의 형식이 아닌경우에 띄워주는 경고창의 문구
