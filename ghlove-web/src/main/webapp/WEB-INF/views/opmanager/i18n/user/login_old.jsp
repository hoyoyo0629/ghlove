	...
	<div class="login_area">
		...
		<form id="loginForm"  action="<c:url value='/op_security_login'/>" method="POST" >
			...
			<fieldset>
				...
				<h2><c:out value="${op:message('M00794')}"/></h2> <!-- 관리자 로그인 -->
				<p class="guide"><c:out value="${op:message('M00795')}"/></p> <!-- 관리자 로그인 후 홈페이지를 관리하실 수 있습니다. -->
				...
				<div class="footer">
					<button type="submit" class="btn btn-orange btn-lg"><span><c:out value="${op:message('M00796')}"/></span></button> <!-- 로그인 ログイン -->
				</div>
			</fieldset>
		</form>
	</div>
