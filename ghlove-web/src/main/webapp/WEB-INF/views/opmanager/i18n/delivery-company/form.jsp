...
<%@ taglib prefix="shop"	uri="/WEB-INF/tlds/shop" %>
			...
			<form:form modelAttribute="deliveryCompany" method="post" enctype="multipart/form-data">
				<input type="hidden" id="kind" value="${fn:escapeXml(kind)}" />
				...
				<div class="board_write">
					<table class="board_write_table">
						...
						<tbody>
							 <tr>
							 	<td class="label"><span class="required_mark">*</span>${op:message('M00665')}</td> <!-- 배송 업체명 -->
							 	<td>
							 ...
							 <tr>
							 	<td class="label"><span class="required_mark">*</span>${op:message('M00671')}</td> <!-- 배송 조회 URL -->
							 	<td>
							 		<div class="flex_box gap-08">
