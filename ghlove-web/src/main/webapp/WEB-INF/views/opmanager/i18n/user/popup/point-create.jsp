				...
				<table cellpadding="0" cellspacing="0" summary="" class="board_list_table">
					...
					<tbody>
						<tr>
							...
							<td class="tleft">
								<div>아이디 : <c:out value="${user.email}"/> (<c:out value="${user.userName}"/>)</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<th scope="row">지급/차감(<c:out value="${unit}"/>)</th>
							<td class="tleft">
								<div>
									<input type="text" name="point" class="required _number full" maxlength="8" title="지급/차감 금액" style="width:200px;" /> <c:out value="${unit}"/>
							 	</div>
							</td>
						</tr>
						<tr>
							<th scope="row"><c:out value="${title} "/> 지급/차감 내용</th>
							<td class="tleft">
								<div class="mt10">
									<textarea name="reason" cols="30" rows="10" title="${fn:escapeXml(title)} 지급/차감 내용" class="required" style="width:350px;"></textarea>
								</div>
							</td>
						</tr>
					</tbody>
