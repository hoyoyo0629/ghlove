...
<div class="board_write">
    <form:form modelAttribute="configGoogleAnalytics" method="post" enctype="multipart/form-data">
        ...
        <table class="board_write_table pg-info" summary="PG 정보">
            ...
            <tbody>
                <tr>
                    <td class="label"><span class="required_mark">*</span>범용 사이트 태그</td>
                    <td>
                        <div class="flex_box gap-12">
                            <div class="input-form">
                                <form:radiobutton path="commonTrackingFlag" value="false" cssClass="required" title="범용 사이트 태그" id="rdo1-1" name="rdo1" checked="checked"/>
                                <label for="rdo1-1">미적용</label>
                            </div>
                            <div class="input-form">
                                <form:radiobutton path="commonTrackingFlag" value="true" cssClass="required" title="범용 사이트 태그" id="rdo1-2" name="rdo1"/>
                                <label for="rdo1-2">적용</label>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="label"><span class="required_mark">*</span>전자상거래</td>
                    <td>
                        <div class="flex_box gap-12">
                            <div class="input-form">
                                <form:radiobutton path="ecommerceTrackingFlag" value="false" cssClass="required" title="전자상거래" id="rdo2-1" name="rdo2" checked="checked"/>
                                <label for="rdo2-1">미적용</label>
                            </div>
                            <div class="input-form">
                                <form:radiobutton path="ecommerceTrackingFlag" value="true" cssClass="required" title="전자상거래" id="rdo2-2" name="rdo2"/>
                                <label for="rdo2-2">적용</label>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="label"><span class="required_mark">*</span>통계</td>
                    <td>
                        <div class="flex_box gap-12">
                            <div class="input-form">
                                <form:radiobutton path="statisticsFlag" value="false" cssClass="required" title="통계" id="rdo3-1" name="rdo3" checked="checked"/>
                                <label for="rdo3-1">미적용</label>
                            </div>
                            <div class="input-form">
                                <form:radiobutton path="statisticsFlag" value="true" cssClass="required" title="통계" id="rdo3-2" name="rdo3"/>
                                <label for="rdo3-2">적용</label>
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <div class="btn_all btn_center">
            <div class="flex_box gap-08">
                <button type="submit" class="btn btn-active btn-small">저장</button>
            </div>
        </div>
    </form:form>
