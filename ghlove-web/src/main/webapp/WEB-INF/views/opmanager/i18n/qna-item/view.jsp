...
<%@ taglib prefix="shop"	uri="/WEB-INF/tlds/shop" %>
		...
		<form id="qnaParam" method="post" action="/opmanager/qna-item/list">
			...
			<input type="hidden" name="sellerId" value="${fn:escapeXml(qnaParam.sellerId)}"/>
		...
		<form:form modelAttribute="qna" method="post" action="/opmanager/qna-item/delete/${fn:escapeXml(qnaId)}">
			...
			<c:choose>
				<c:when test="${qnaAnswer.qnaAnswerId > 0}">
					...
					<div class="btn_center">
						...
						<a href="/opmanager/qna-item/delete/${fn:escapeXml(qnaId)}" id="delete_data" class="btn btn-default">삭제</a>
