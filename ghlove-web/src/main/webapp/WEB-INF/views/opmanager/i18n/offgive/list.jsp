	...
	<div class="board_write">
	                ...
	                <td colspan="3">
	                    <div class="flex_box gap-08">
	                        <form:select path="shKeyword" title="검색구분" class="wd-150">
	                            ...
	                            <form:option value="RCEPT_BANK_NM">지점/센터명</form:option>
	                        </form:select>
		...
		<div class="btn_all btn_left">
			<ul class="list-bullet point">
				<li>
					기탁서 등록 후 정상 처리까지 최대 1시간 가량 소요될 수 있습니다.
				</li>
		        <li>
	    ...
	    <div class="btn_all btn_right">
	        <div class="flex_box gap-08">
	            <button type="button" class="btn btn-dark-gray btn-mini" onclick="location.href='/opmanager/offgive/list';">초기화</button>
...
<!-- 	                </td> -->
	                ...
	                <td>
	                    <a href="/opmanager/offgive/detail/${fn:escapeXml(list.cntrSn)}"><c:out value="${list.cntrSn}"/></a>
	                </td>
	                <td>
	    ...
	    <div class="btn_all flex_box juc-sbt">
	        ...
	        <div class="btn_right">
	            <div class="flex_box gap-08">
	            	<c:if test="${role != 'SYSTEM'}">
	                	<button type="button" class="btn btn-dark-default btn-mini" onClick="location.href='/opmanager/offgive/create'">기탁서 등록</button>
	                </c:if>
...
function downloadExcel() {
    ...
    Shop.downloadExcelOrder("/opmanager/offgive/list/download-excel", $('#searchParam').serialize(), true);
}
...
function listPrint() {
	...
	window.open('/opmanager/offgive/popup/form-list?startDt='+$('#shFrstRegistPnttmStart').val()
