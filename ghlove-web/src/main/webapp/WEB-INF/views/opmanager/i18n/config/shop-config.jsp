	...
	width: 60px;
		...
		<form:form modelAttribute="config" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td colspan="3">
							...
							<div>
								...
								<input type="text" name="post" id="post" value="${fn:escapeXml(config.post)}" class="required" title="${op:message('M00115')}  ${op:message('M00107')}" maxlength="5" class="one" readonly="readonly">
			...
			<div class="btn_all btn_center">
				...
				<button type="submit"  class="btn btn-dark-gray btn-small"><span>${op:message('M00101')}</span></button> <!-- 저장 -->	
				</div>
			</div>			 
			<!-- 버튼 끝-->
		</form:form>					 							
...
$(function() {
	...
	var array = ${fn:escapeXml(jsonSize)};
	var html = '';
