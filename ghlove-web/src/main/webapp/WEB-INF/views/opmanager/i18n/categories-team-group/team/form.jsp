								...
								<ul id=related class="sortable_item_relation">
									...
									<c:forEach items="${itemList}" var="item" varStatus="i">
										<c:if test="${!empty item.itemId}">
											<li id="related_item_${fn:escapeXml(item.itemId)}">
												<input type="hidden" name="relatedItemIds" value="${fn:escapeXml(item.itemId)}" />
												...
												<a href="javascript:Shop.deleteRelationItem('related_item_${fn:escapeXml(item.itemId)}');" class="delete_item_image"><img src="/content/opmanager/images/icon/icon_x.gif" alt="" /></a>
											</li>
										</c:if>
									</c:forEach>
