...
$(function(){
	...
	var order = '${fn:escapeXml(proposalEmployeeStatisticsSearchParam.order) }'.toLowerCase();
	var sort = '${fn:escapeXml(proposalEmployeeStatisticsSearchParam.sort) }'.toLowerCase();
