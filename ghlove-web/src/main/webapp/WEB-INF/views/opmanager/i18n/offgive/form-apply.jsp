...
// 		// 1.cntr_deposit.ozr
		...
		oz.sendToActionScript("connection.reportname","/6.cntr_application_form_prj.ozr");
		oz.sendToActionScript("odi.odinames","6_cntr_application_form");

		oz.sendToActionScript("odi.6_cntr_application_form.pcount","1");
		oz.sendToActionScript("odi.6_cntr_application_form.args1","CNTR_SN=${fn:escapeXml(cntrSn)}");
