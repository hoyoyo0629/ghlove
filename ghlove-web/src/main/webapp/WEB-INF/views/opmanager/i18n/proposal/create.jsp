...
<%@ taglib prefix="module" 	tagdir="/WEB-INF/tags/modules"%>
	...
	<div class="practice donation">
		<form:form modelAttribute="proposal" id="proposal"  action="${fn:escapeXml(requestContext.opmanagerUri)}/proposal/create" method="post" enctype="multipart/form-data">
			<form:input path="userId" value="${fn:escapeXml(requestContext.user.userId)}" />
			<table>
				<tr>
					<td>제목</td>
				...
				<tr>
					<td>신청기관</td>
					<td> <form:input path="userName" title="신청기관" cssClass="required _filter"  value="${fn:escapeXml(requestContext.user.userName)}" /> </td>
				</tr>
				...
				<tr>
					<td>목표금액</td>
					<td> <form:input path="targetAmount" title="목표금액" cssClass="required _filter" value="${fn:escapeXml(requestContext.user.userName)}" /> </td>
				</tr>
				<tr>
