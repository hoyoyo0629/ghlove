...
<div>
	...
	<p style="margin-top:10px; margin-bottom:50px; text-align:center; font-size: 20px; font-weight: 400; color:red">타인의 개인정보를 작성하지 않도록 각별히 유의 해주시기 바랍니다.</p>
</div>
...
<form:form modelAttribute="searchParam" method="post">
	...
	<div class="board_write">
		<table class="board_write_table" summary="${op:message('자유게시판')}">
			<colgroup>
		...
		<div class="btn_all btn_right">
			<div class="flex_box gap-08">
				<button type="button" class="btn btn-default btn-mini"
					onclick="location.href='/opmanager/community/bbs/list'">
...
<div class="board_list">
			...
			<c:forEach items="${list}" var="community" varStatus="i">
				<tr>
					...
					<td>
						...
						<%-- <div class="freeboard-title-wrap" >
							<c:if test="${community.noticeYn == 'Y'}">
								<span class="label_notice">공지</span>
							</c:if>
							<a class="communityId"
								href="javascript:communityDetail('${community.bbsId}')">${community.bbsTtl}</a>
							<c:if test="${community.cmntCnt > 0}">
								<span class="comment-count"
									data-community-id="${community.bbsId}">[${community.cmntCnt}]</span>
							</c:if>
						</div> --%>
					</td>
	...
	<div class="btn_all btn_right">
		<div class="flex_box gap-08">
			<a href="<c:url value="/opmanager/community/bbs/form" />"
...
<script type="text/javascript">
	...
	function communityDetail(id) {
		...
		location.href = '/opmanager/community/bbs/detail/' + id;
	}
