...
<div class="board_write">
  ...
  <div class="btn_all btn_right">
      <div class="flex_box gap-08">
          <button type="button" class="btn btn-dark-gray btn-mini" onclick="location.href='/opmanager/give/statistics/amount';">초기화</button>
...
function detail(cntrYear, locgovCode) {
	location.href = '/opmanager/give/statistics/amount/' + locgovCode;
}

function downloadExcel() {
    Shop.downloadExcelOrder("/opmanager/give/statistics/amount/excel", $('#searchParam').serialize(), true);
}
