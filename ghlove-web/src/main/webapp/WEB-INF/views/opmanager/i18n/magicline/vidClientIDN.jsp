...
<%
	...
	//MagicE2E.setConfPath("C:/icraft/workspace/ghlove/magicline/config");
	//int setJcaosLicensePathResult = MagicE2E.setJcaosLicensePath("C:/icraft/workspace/ghlove/magicline/config");
	MagicE2E.setConfPath("C:/workspace/ghlove/magicline/config");
	int setJcaosLicensePathResult = MagicE2E.setJcaosLicensePath("C:/workspace/ghlove/magicline/config");
	// 세션에 값이 있는지 확인
...
<div id="middle">
	...
	<form id='reqForm' name='reqForm' method='post' action="/opmanager/magicline/vidClientIDNR">
