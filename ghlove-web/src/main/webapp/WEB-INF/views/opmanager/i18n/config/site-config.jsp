...
<%@ taglib prefix="page" tagdir="/WEB-INF/tags/page" %>
		...
		<h3><span><c:out value="${op:message('M00102')}"/></span></h3>
			...
			<div class="board_write">
				...
				<table class="board_write_table" summary="사이트 기본설정">
					...
					<tbody>
						<tr>
						 	<td class="label"><c:out value="${op:message('M00091')}"/> (<c:out value="${op:message('M00092')}"/> )</td>
						 	<td>
						 		<div>
						...
						<tr>
						 	<td class="label"><c:out value="${op:message('M00090')}"/> </td>
						 	<td>
						 		<div>
					 	...
					 	<tr>
						 	<td class="label"><c:out value="${op:message('M00093')}"/> </td>
						 	<td>
						 		<div>
					 	...
					 	<tr>
						 	<td class="label"><c:out value="${op:message('M00094')}"/> </td>
						 	<td>
						 		<div>
					 	...
					 	<tr>
						 	<td class="label"><c:out value="${op:message('M00999')}"/></td> <!-- H1태그 -->
						 	<td>
						 		<div>
					 	...
					 	<tr>
						 	<td class="label"><c:out value="${op:message('M01000')}"/></td> <!-- 테마워드용 타이틀 -->
						 	<td>
						 		<div>
					 	...
					 	<tr>
						 	<td class="label"><c:out value="${op:message('M01001')}"/></td> <!-- 테마워드용 기술서 -->
						 	<td>
						 		<div>
				  		...
				  		<tr>
						 	<td class="label"><c:out value="${op:message('M01074')}"/></td> <!-- 로그인 영역 TEXT -->
						 	<td>
						 		<div>
