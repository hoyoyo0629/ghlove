...
<%
	...
	if (sSignData != null && sSignData.length() > 0){
		try	{
			...
			JCaosCheckCert jcaosCheck = new JCaosCheckCert(request.getAttribute("prop-path").toString());
// 			JCaosCheckCert jcaosCheck = new JCaosCheckCert("C:/testbuild/workspace/ghlove/ghlove-web/src/main/webapp/WEB-INF/magicline/config/magicline.properties");
