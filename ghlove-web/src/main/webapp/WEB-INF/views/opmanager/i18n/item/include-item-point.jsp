...
<%@ taglib prefix="shop"	uri="/WEB-INF/tlds/shop" %>
												...
												판매가에서 
												<input type="text" name="point" maxlength="6" value="${fn:escapeXml(pointConfig.point)}" class="required-seller-point _min_0 _number_comma amount" title="${op:message('M00246')}" />
