						...
						<tbody>
									...
									<div>
										<c:choose>
											...
											<c:otherwise>
												...
												<span>(영문, 숫자 조합으로 6~14자로 입력해 주십시오.)</span>
											</c:otherwise>
										</c:choose>
								    </div>
								</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div>
                                        <input type="text" id="phoneNumber1" maxlength="3" Class="form-phone _number required" value="${fn:escapeXml(phoneNumber1)}" title="핸드폰 첫 번째 자리"> -
										<input type="text" id="phoneNumber2" maxlength="4" Class="form-phone _number_masking required" value="${fn:escapeXml(phoneNumber2)}" title="핸드폰 두 번째 자리"> -
                                        <input type="text" id="phoneNumber3" maxlength="4" Class="form-phone _number required" value="${fn:escapeXml(phoneNumber3)}" title="핸드폰 세 번째 자리">
                                    </div>
                                </td>
                            </tr>
							...
							<tr>
                                ...
                                <c:if test="${formAction == 'create'}">
                                    <td>
                                        <div>
                                                <input type="password"  name="password" id="password" title="${op:message('M00150')} " class="form-half ${fn:escapeXml(required)} _password" minlength="4"  maxlength="20"/>
                                        </div>
                                    </td>
                                </tr>
                                    <tr>
                                         ...
                                         <td>
                                             <div>
                                                 <input type="password" name="password2" id="password_confirm" title="${op:message('M00151')} " class="form-half ${fn:escapeXml(required)} _password" minlength="4"  maxlength="20"/>
                                             </div>
                                         </td>
                                </c:if>
							...
							<tr>
								...
								<td>
									<div>
										<form:input path="email" title="${op:message('M00125')} " cssClass="form-half optional _email_masking" maxlength="100" />
	...
	function idCheck(){
		$("#idCheckBtn").on('click',function(){
			...
			if (loginId != '') {
				...
				var idReg=/^[a-zA-Z]{1}[a-zA-Z0-9]{5,14}$/g;

				if(!idReg.test($("#loginId").val())) {
					alert("영문, 숫자 조합으로 6~14자로 입력해 주십시오.");
					return;
				}
