...
<div class="board_write">
  ...
  <div class="btn_all btn_right">
      <div class="flex_box gap-08">
          <button type="button" class="btn btn-dark-gray btn-mini" onclick="location.href='/opmanager/give/statistics/number';">초기화</button>
...
function detail(cntrYear, locgovCode) {
	location.href = '/opmanager/give/statistics/number/' + locgovCode;
}

function downloadExcel() {
    Shop.downloadExcelOrder("/opmanager/give/statistics/number/excel", $('#searchParam').serialize(), true);
}
