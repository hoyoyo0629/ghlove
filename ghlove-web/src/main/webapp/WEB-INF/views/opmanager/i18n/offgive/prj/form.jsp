...
<div class="btn_all btn_right mb15">
    <div class="flex_box gap-08">
        ...
        <button type="button" class="btn btn-dark-gray btn-small" onclick="window.open('/opmanager/offgive/prj/popup/form-policy','pop','width=900,height=1200');">기탁서 양식 및 약관 출력</button>
    </div>
</div>

<form:form modelAttribute="offgive" method="post" action="/opmanager/offgive/prj/create">
	    ...
	    <table class="board_write_table" summary="">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td>
	                    <div class="flex_box gap-08 item-center">
	                        <input id="cntrAmt" name="cntrAmt" title="" class="input_txt required _filter wd-150 _number_comma" type="text" maxlength="8" disabled>
	                        ...
	                        <span class="wave tip">※ 일년에 최대 2천만원까지 기부가 가능합니다.</span>
	                    </div>
	                </td>
	            </tr>
	            <tr>
	...
	<div class="btn_all btn_center">
	    <div class="flex_box gap-08">
	        ...
	        <button type="button" class="btn btn-defualt btn-small" onClick="location.href='/opmanager/offgive/prj/create'">초기화</button>
	    </div>
	</div>
...
function goSave() {
		...
		$.post(url("/opmanager/offgive/create"), $('#offgive').serialize(), function(response) {
			...
			//if(response.isSuccess && response.data) {
			if(response.isSuccess) {
				location.href = "/opmanager/offgive/prj/detail/" + response.data
			} else {
				alert(response.errorMessage);
