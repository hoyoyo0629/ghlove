				...
				<div class="board_write" style="margin-top: 20px;">
					...
					<table class="board_list_table" summary="상품리스트">
						...
						<tbody>
							...
							<tr id="item">
								<td><span style="background: ${fn:escapeXml(code.value)}" class="color_box"></span></td>
								<td><c:out value="${code.value}"/></td>
								<td class="title"><c:out value="${code.label}"/></td>
								<td>
									<a href="javascript:deleteCode('${fn:escapeXml(code.value)}')" class="btn_write gray_small">삭제</a>
								</td>
