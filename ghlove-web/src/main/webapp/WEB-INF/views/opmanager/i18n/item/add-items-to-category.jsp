				...
				<form:form modelAttribute="itemParam" method="post">
					...
					<div class="category_wrap">
						...
						<form:select path="categoryGroupId" class="category multiple" size="12">
							<option value="0">= <c:out value="${op:message('M00076')}"/> =</option> <!-- 팀/그룹 -->
...
$(function() {
	...
	Shop.activeCategoryClass('${fn:escapeXml(itemParam.categoryGroupId)}', '${fn:escapeXml(itemParam.categoryClass1)}', '${fn:escapeXml(itemParam.categoryClass2)}'
			, '${fn:escapeXml(itemParam.categoryClass3)}', '${fn:escapeXml(itemParam.categoryClass4)}');
