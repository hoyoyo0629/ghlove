...
<div class="popup_wrap">
    <h1 class="popup_title"><c:out value="${op:message('MENU_1401')}"/></h1> <!-- 공통코드 관리 -->
		...
		<form:form modelAttribute="code" method="post" enctype="multipart/form-data">
			...
			<div class="board_write">
				...
				<table class="board_write_table">
					<caption><c:out value="${op:message('MENU_1401')}"/></caption> <!-- 공통코드 관리 -->
					<colgroup>
					...
					<tbody>
						<tr>
							<td class="label"><c:out value="${op:message('M01680')}"/> <font color=red>*</font></td> <!-- 코드구분 -->
							<td>
								<div>
						...
						<tr>
							<td class="label"><c:out value="${op:message('M01374')}"/> <font color=red>*</font></td> <!-- 코드 -->
							<td>
								<div>
						...
						<tr>
							<td class="label"><c:out value="${op:message('M01674')}"/></td> <!-- 코드라벨 -->
							<td>
								<div>
									<form:input type="text" path="label" title="${op:message('M01674')}" class="nine" maxlength="40"/>
								</div>
							</td>
						</tr>
						<tr>
							<td class="label"><c:out value="${op:message('M01677')}"/></td> <!-- 코드상세 -->
							<td>
								<div>
									<form:input type="text" path="detail" title="${op:message('M01677')}" class="nine" maxlength="55"/>
								</div>
							</td>
						</tr>
						<tr>
							<td class="label"><c:out value="${op:message('M01678')}"/></td> <!-- 정렬순서 -->
							<td>
								<div>
						...
						<tr>
							<td class="label"><c:out value="${op:message('M01682')}"/></td> <!-- 상위ID  -->
							<td>
								<div>
						...
						<tr>
							<td class="label"><c:out value="${op:message('M01675')}"/></td> <!-- 코드값  -->
							<td>
								<div>
						...
						<tr>
							<td class="label"><c:out value="${op:message('M01684')}"/></td> <!-- 확장코드  -->
							<td>
								<div>
						...
						<tr>
							<td class="label"><c:out value="${op:message('M01685')}"/></td> <!-- 매핑코드  -->
							<td>
								<div>
			...
			<div class="btn_center">
				...
				<a href="JavaScript:self.close();" class="btn btn-dark-gray"><span><c:out value="${op:message('M00569')}"/></span></a> <!-- 닫기 -->
			</div>
			<!-- 버튼 끝-->
		</form:form>
    </div>
