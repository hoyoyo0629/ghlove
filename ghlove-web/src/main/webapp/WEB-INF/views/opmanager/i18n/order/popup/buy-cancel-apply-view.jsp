...
<div class="popup_wrap">
	<form:form modelAttribute="orderCancelApply" name="orderCancelApply" method="post" onsubmit="return Manager.Order.orderCancelApplyAction('${fn:escapeXml(pageType)}')">
		...
		<div class="popup_contents">
			...
			<div class="board_list">
				<h3><span>${fn:escapeXml(orderCancelApply.orderCode)} - 취소 신청 상품 정보</span></h3>
		 		<table class="board_list_table" summary="주문내역 리스트">
		 			...
		 			<tbody>
						...
						<c:forEach items="${ orderCancelApply.orderShipping.orderItems }" var="orderItem" varStatus="itemIndex">
			 				<tr>
			 					<td>
			 						<input type="hidden" name="orderItemIds" value="${fn:escapeXml(orderItem.orderItemId)}" />
			 						<input type="checkbox" name="ids" value="${fn:escapeXml(orderItem.orderItemId)}" checked="checked" />
			 					</td>
								<td class="left none_left">
			 						<div class="arrival3">
			 							<p class="code">[${fn:escapeXml(orderItem.itemUserCode)}]</p>
			 							<p class="name">${fn:escapeXml(orderItem.itemName)}</p>
