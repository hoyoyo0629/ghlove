...
<script type="text/javascript">
	...
	function validator() {
		...
		let reqCode = $(reqstSeCodeObj).val();

		if(reqCode == 'ROLE_ADMIN_6' || reqCode == 'ROLE_ADMIN_10') {
			if($('#upperLocgov').val() == '') {
	...
	function setParam() {
		...
		// 소속구분 : 지자체
		if(reqstSeCode == 'ROLE_ADMIN_6' || reqstSeCode == 'ROLE_ADMIN_10') {
