...
<!--팝업 리스트 시작-->
		...
		<h3><span><c:out value="${op:message('M00660')}"/></span></h3> <!-- 배송/반품/환불/교환안내 설정 --> 
		<div class="board_write">
			<form:textarea path="deliveryInfo" cols="30" rows="40" class="editor-content editor-lg" style="width: 1085px"  title="${op:message('M00661')}" />
		</div>  <!--//board_write E-->
		<p class="red01 mt10">* <c:out value="${op:message('M00662')}"/></p> <!-- 상품 구매시 배송/반품/환불 안내 화면에 입력한 내용이 기본으로 출력됩니다. -->
