...
<%
	...
	if (sSignData != null && sSignData.length() > 0){
		try	{
			...
			//JCaosCheckCert jcaosCheck = new JCaosCheckCert("C:/icraft/workspace/ghlove/magicline/config/magicline.properties");
			JCaosCheckCert jcaosCheck = new JCaosCheckCert("C:/workspace/ghlove/magicline/config/magicline.properties");
