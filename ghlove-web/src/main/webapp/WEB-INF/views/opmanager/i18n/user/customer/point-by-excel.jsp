...
<%@ taglib prefix="op" 		uri="/WEB-INF/tlds/functions" %>
		...
		<div class="popup_wrap">
			<h1 class="popup_title"><c:out value="${op:message('M00826')}"/></h1> <!-- 포인트 지급 -->
			<form:form modelAttribute="point" method="post" enctype="multipart/form-data">
				<div class="popup_contents">
					<h2>¶ $<c:out value="{op:message('M00826')}"/> <a href="../../../../content/sample/point_sample.xlsx" class="table_btn" style="float: right;margin-bottom: 10px;" download><span><c:out value="${op:message('M01280')}"/></span></a> <!-- 샘플 다운로드 --></h2> <!-- 포인트 지급 -->
						
					<table cellpadding="0" cellspacing="0" summary="" class="board_list_table">
						<caption><c:out value="${op:message('M00246')}"/> 지급</caption>
						<colgroup>
							<col style="width:35%;" />
							<col style="width:*" />
						</colgroup>
						<tbody>
							<tr>
								<th scope="row"><c:out value="${op:message('M01070')}"/></th> <!-- 파일  -->
								<td class="tleft">
							...
							<tr>
								<th scope="row"><c:out value="${op:message('M01106')}"/></th> <!-- 지급 포인트 -->
								<td class="tleft">
									<div>
							...
							<tr>
								<th scope="row"><c:out value="${op:message('M01107')}"/></th> <!-- 포인트 지급 내용 -->
								<td class="tleft">
									<div class="mt10">
