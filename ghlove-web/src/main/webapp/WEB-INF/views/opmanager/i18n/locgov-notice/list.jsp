...
<%-- 	                                    <form:option value="">전체</form:option> --%>
		...
		<div class="btn_all btn_right">
			<div class="flex_box gap-08">
				<button type="button" class="btn btn-default btn-mini" onclick="location.href='/opmanager/locgov-notice/list'"><c:out value="${op:message('M00047')}"/></button> <!-- 초기화 -->
	...
	<div class="board_list">
		...
		<div class="btn_all btn_right">
			<div class="flex_box gap-08">
				<a href="<c:url value="/opmanager/locgov-notice/create" />" class="btn btn-dark-gray btn-mini"><c:out value="${op:message('M00088')}"/></a> <!-- 등록 -->
...
function deleteCheckNotice() {
	...
	if(confirm("삭제하시겠습니까?")) {
		$.post('/opmanager/locgov-notice/deleteNotice', {"locgovNoticeList": locgovNoticeList}, function(response) {
...
function noticeDetail(noticeId) {
	...
	location.href = '/opmanager/locgov-notice/edit/'+noticeId;
}
