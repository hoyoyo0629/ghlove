			...
			<tbody>
				...
				<c:forEach items="${list}" var="orderItem" varStatus="index">
					...
					<tr style="background:#fff;">
						...
						<c:if test="${requestContext.sellerPage == false}">
						<td>
							<p><c:out value="${orderItem.telephoneNumber}"/></p>
						</td>
						</c:if>
						...
						<td><div><c:out value="${orderItem.mobile}"/></div></td>
						<td><div><c:out value="${orderItem.receiveZipcode}"/></div></td>
						<td><div><c:out value="${orderItem.receiveAddress}"/> <c:out value="${orderItem.receiveAddressDetail}"/></div></td>
						<c:if test="${!requestContext.sellerPage}">
