									...
									<tr>
										<td>
											<div style="width: 30px; text-align: center">
												<input type="checkbox" name="id" value="${fn:escapeXml(item.itemId)}" class="${fn:escapeXml(item.itemUserCode)}" title="" />
											</div>									
										</td>
										<td>
											<c:choose>
										...
										<td>
											...
											<input type="hidden" name="itemUserCodes" value="${fn:escapeXml(item.itemUserCode)}" />
										</td>
										<td class="left break-word">
											<input type="text" name="itemNames" value="${fn:escapeXml(item.itemName)}" class="required" title="상품명" />
										</td>
										<%-- <td>
											<input type="text" name="costPrices" value="${item.costPrice}" class="required _number_comma" title="원가" />
										</td> --%>
										<td> 
											<input type="text" name="itemPrices" class="_number_comma" value="${fn:escapeXml(item.itemPrice)}" />
										</td>
										<td>
											<input type="text" name="salePrices" value="${fn:escapeXml(item.salePrice)}" class="required _number_comma" title="판매가"  />
										</td>
										<td>
											<div style="width: 120px" class="text-center">
												${fn:escapeXml(item.seller.sellerName)}
											</div> 
										</td>
										<td>
											<input type="text" name="manufacturers" value="${fn:escapeXml(item.manufacturer)}" title="제조사" />
										</td>
										<td>
											<input type="text" name="originCountries" value="${fn:escapeXml(item.originCountry)}" title="원산지" />
										</td>
