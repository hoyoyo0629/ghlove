...
//         4.cntr_report.ozr
        ...
        oz.sendToActionScript("odi.4_cntr_report.pcount","5");
        oz.sendToActionScript("odi.4_cntr_report.args1","START_DT=${fn:escapeXml(startDt)}");
        oz.sendToActionScript("odi.4_cntr_report.args2","END_DT=${fn:escapeXml(endDt)}");
        oz.sendToActionScript("odi.4_cntr_report.args3","RCEPT_BANK_CODE=${fn:escapeXml(rceptBankCode)}");
        oz.sendToActionScript("odi.4_cntr_report.args4","RCEPT_BANK_NM=${fn:escapeXml(rceptBankNm)}");
        oz.sendToActionScript("odi.4_cntr_report.args5","RCEPT_BANK_CODE_NM=${fn:escapeXml(rceptBankCodeNm)}");
