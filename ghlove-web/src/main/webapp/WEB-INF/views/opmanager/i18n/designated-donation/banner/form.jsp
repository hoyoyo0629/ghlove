	...
	<c:if test="${banner.representativeBannerId > 0}">
	    <div class="btn_all btn_right mb15">
	        <div class="flex_box gap-08">
	            ...
	            <button type="button" class="btn btn-default btn-mini" onclick="location.href='/opmanager/designated-donation/banner/list'">목록</button>
	        </div>
	    </div>
    </c:if>
	...
	<c:if test="${banner.representativeBannerId == null}">
	    <div class="btn_all btn_center mt30">
	        <div class="flex_box gap-08">
	            ...
	            <button type="button" class="btn btn-default btn-small" onclick="location.href='/opmanager/designated-donation/banner/list'">취소</button>
	        </div>
	    </div>
	</c:if>
</form>
...
<script type="text/javascript">
	...
	function deleteBanner(id,type) {
		...
		if (confirm(message)) {
			$.post("/opmanager/designated-donation/banner/delete", param, function(resp){
