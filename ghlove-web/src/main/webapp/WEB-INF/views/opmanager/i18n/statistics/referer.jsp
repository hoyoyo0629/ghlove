    ...
    <tr>
        ...
        <td style="padding:0 20px" valign="top">
			...
			<table class="opmanager-search-table margin-top-5">
			    <tr>
			        <th>기간</th>
					<td><input type="text" class="txt" id="sdate" value="${fn:escapeXml(startDate)}" /> ~ <input type="text" class="txt" id="edate" value="${fn:escapeXml(endDate)}" /></td>
			    </tr>
			    <tr>
			        <th>항목</th>
				...
				<c:if test="${!empty visitList}">
					<c:forEach items="${visitList}" var="visit" varStatus="i">
					        ...
					        <tr>
					            ...
					            <td align=left><c:out value="${visit.title}"/></td>
					            <td><c:out value="${visit.count}"/></td>
					            <td><c:out value=">${visit.ratio}"/></td>
					        </tr>			
