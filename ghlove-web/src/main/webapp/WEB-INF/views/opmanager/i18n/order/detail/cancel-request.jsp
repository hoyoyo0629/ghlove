...
<div class="popup_wrap">
	<h3 class="popup_title"><span><c:out value="${orderShipping.orderCode}"/> - 주문 정보</span></h3>
			...
			<table class="board_write_table">
				...
				<tbody>
					<tr>
						...
						<td class="tleft">
							<div>
								<c:out value="${orderShipping.orderCancelApply.cancelReasonText}"/>
							</div>
						</td>
					</tr>
					<tr>   
						...
						<td colspan="3" class="tleft">
							<div>
								<c:out value="${op:nl2br(orderShipping.orderCancelApply.cancelMemo)}"/>
							</div>
						</td> 
					</tr> 
				</tbody>
