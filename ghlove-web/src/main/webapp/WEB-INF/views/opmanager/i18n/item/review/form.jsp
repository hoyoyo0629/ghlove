	            ...
	            <table class="board_write_table" summary="">
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        ...
	                        <td colspan="3">
	                            <div>
	                                <form:input path="subject" title="${op:message('제목')}" class="input_txt required _filter full" type="text"  readonly="true"/>
	                            </div>
	                        </td>
	                    </tr>
	                    <tr>
	                        ...
	                        <td colspan="3">
	                            <div>
	                                ...
	                                <span class="placeholder_wrap">
	                                    <form:textarea path="content" cols="30" rows="10" maxlength="140" class="required _filter" title="${op:message('M00006')}" readonly="true"></form:textarea><!-- 내용 -->
	                                </span>
	                            </div>
	                        </td>
	                    </tr>
...
function deleteItemReview(itemReviewId) {
	if (itemReviewId) {
		...
		Common.loading.show();
		$.ajax ({
			url	: "/opmanager/item/review/delete/" + itemReviewId,
			type	: "POST",
			...
			success : function(response, status, xhr) {
			    if (response.isSuccess) {
			    	...
			    	if (response.errorMessage) {
			    		...
			    		alert("${op:message('실패했습니다.')}");		// 실패했습니다.
			    	}
			    }
			},
