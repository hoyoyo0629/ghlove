...
<%@ taglib prefix="op" 		uri="/WEB-INF/tlds/functions" %>
		...
		<div class="btn_all btn_right mb15">
		    <div class="flex_box gap-08">
		        ...
		        <button type="button" class="btn btn-dark-default btn-mini" onClick="location.href='/opmanager/give/give-notice/list'">목록</button>
		    </div>
		</div>
		</c:if>
		...
		<div class="board_write">
			...
			<div class="btn_all btn_center">
				<div class="flex_box gap-08">
					...
					<button type="button" class="btn btn-defualt btn-small" onclick="location.href='/opmanager/give/give-notice/list'"><c:out value="${op:message('M00037')}"/></button>
				</div>
			</div>
			</c:if>
...
function deleteNoticeSeller(noticeSellerId, sellerId){
	...
	$.post('/opmanager/give/give-notice/delete-notice-seller/'+noticeSellerId, null, function(response) {
	...
	Common.confirm("${op:message('M00196')}", function() {
		$.post(url("/opmanager/give/give-notice/delete/" + noticeId), {}, function(response) {
			Common.responseHandler(response, function() {
				...
				location.href = "/opmanager/give/give-notice/list";
// 				location.reload();
			});
		});
	});
