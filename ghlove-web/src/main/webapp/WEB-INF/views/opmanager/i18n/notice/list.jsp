		...
		<div class="btn_all btn_left">
			<ul class="list-bullet point">
				...
				<div class="btn_all btn_right">
					<div class="flex_box gap-08">
						<button type="button" class="btn btn-default btn-mini" onclick="location.href='/opmanager/notice/list'"><c:out value="${op:message('M00047')}"/></button> <!-- 초기화 -->
...
<%-- 								<td>
		...
		<div class="btn_all btn_right">
			<div class="flex_box gap-08">
				<a href="<c:url value="/opmanager/notice/create" />" class="btn btn-dark-gray btn-mini"><c:out value="${op:message('M00088')}"/></a> <!-- 등록 -->
...
function deleteCheckNotice() {
	...
	if(confirm("삭제하시겠습니까?")) {
		$.post('/opmanager/notice/deleteNotice', {"noticeList": noticeList}, function(response) {
