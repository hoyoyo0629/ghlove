...
<%@ taglib prefix="shop"	uri="/WEB-INF/tlds/shop" %>
		...
		<form:form modelAttribute="item" action="${fn:escapeXml(action)}" method="post" enctype="multipart/form-data">
			...
			<div class="item_list mt60">
				...
				<form:textarea path="detailContent" cols="30" rows="20" class="editor-content" title="상품상세설명" />
			</div>
			...
			<div class="item_list mt30">
				...
				<form:textarea path="detailContentMobile" cols="30" rows="6" class="editor-content" title="모바일 상품상세설명" />
			</div>

			<div class="item_list mt30">
				<h3><span>사용방법</span></h3>

				<form:textarea path="useManual" cols="30" rows="3" class="editor-content" title="사용방법" />
			</div>

			<div class="item_list mt30">
				<h3><span>조립방법</span></h3>

				<form:textarea path="makeManual" cols="30" rows="3" class="editor-content" title="조립방법" />
			</div>
