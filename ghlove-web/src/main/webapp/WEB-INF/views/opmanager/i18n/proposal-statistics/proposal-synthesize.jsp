...
<div class="chart_area">
	<div class="ratio">
		<div>
			<div class="info">
				<p><span class="label">${fn:escapeXml(searchYear)}년 목표</span> <span class="amount"><em><fmt:formatNumber value="${ fn:escapeXml(proposalTarget.targetAmount) }" pattern="#,###" /></em>원</span></p>
				<p class="present"><span class="label">현재 모금액</span> <span class="amount"><em><fmt:formatNumber value="${ fn:escapeXml(proposalTarget.donationAmount) }" pattern="#,###" /></em>원</span></p>
				<p class="goal_ratio"><span class="label">목표 달성율</span> <span class="amount"><em><fmt:formatNumber value="${ fn:escapeXml(proposalTarget.donationParticipationRate) }" pattern="###,###.##" /></em>%</span></p>
			</div>
			<div class="chart_vertical">/ghlove-web/src/main/webapp/WEB-INF/views/opmanager/i18n/statistics/referer.jsp
				<table>
					<tr>
	...
	<div class="headcount">
		<div>
			<div class="info">
				<p>
					<span class="present"><span class="label">누적 참여자</span> <span class="amount"><em><fmt:formatNumber value="${fn:escapeXml(proposalStatisticsTotal)}" pattern="#,###"  /></em>명</span></span>
					<span class="sort">
