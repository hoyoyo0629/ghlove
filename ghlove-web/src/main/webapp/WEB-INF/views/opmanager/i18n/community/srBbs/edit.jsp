...
<form:form modelAttribute="cmntySrBbsDto" method="post" action='${fn:escapeXml(requestContext.requestUri)}' enctype="multipart/form-data">
...
$(function() {
	try{
		$('#cmntySrBbsDto').validator(function() {
...
$(function(){
	$("#cmntySrBbsDto").on("submit", function(e){
...
function deleteItemImage(fileId) {
	...
	$.post('/opmanager/community/srBbs/delete-item-image', param, function(response){
