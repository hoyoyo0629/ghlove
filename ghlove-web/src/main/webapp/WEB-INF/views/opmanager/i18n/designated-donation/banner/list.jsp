	        ...
	        <tbody>
	        	<c:forEach items="${bannerList}" var="banner" varStatus="i">
	        		<tr style="background:#fff;">
	        			<td>
	        				...
	        				<div><c:out value="${banner.title}" /></div>
	        			</td>
	                    <td>
	                        <div><c:out value="${banner.useYn}" /></div>
	                    </td>
	                    <td>
	                        <div class="flex_box juc-center gap-08">
	                            <button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='/opmanager/designated-donation/banner/form/${fn:escapeXml(banner.representativeBannerId)}'">수정</button>
	                        </div>
	                    </td>
	                    <td>
	        	...
	        	<c:forEach begin="1" end="${insertRow}" step="1">
	                <tr style="background:#fff;">
	                    ...
	                    <td>
	                        <div class="flex_box juc-center gap-08">
	                            <button type="button" class="btn btn-default btn-sm" onclick="location.href='/opmanager/designated-donation/banner/form/0'">등록</button>
	                        </div>
	                    </td>
	                    <td>
	                        <div class="flex_box juc-center">
...
<script type="text/javascript">
	...
	function changeOrdering() {
		...
		$.post("/opmanager/designated-donation/banner/change-ordering", $form.serialize(), function(response) {
