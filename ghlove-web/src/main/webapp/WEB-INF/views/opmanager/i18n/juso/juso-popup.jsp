...
<% 
	...
	String confmKey = "U01TX0FVVEgyMDIyMTEyNTE0MTUzMTExMzI1OTc="; // 검색API 승인키
	String domain = "https://business.juso.go.kr"; // 인터넷망
...
<script type="text/javascript" src="/content/modules/juso/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="/content/opmanager/css/juso/addrlink.css"></link>
