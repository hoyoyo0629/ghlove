...
<form:form modelAttribute="orderSearchParam" action="" method="post">
	...
	<div class="btn_all">
		<div class="btn_left">
			<button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='/opmanager/order/list<c:if test="${ !empty searchOrderStatus }">/${fn:escapeXml(searchOrderStatus)}</c:if>'"><span class="glyphicon glyphicon-repeat"></span> ${op:message('M00047')}<!-- 초기화 --></button>
		</div>
		<div class="btn_right">
