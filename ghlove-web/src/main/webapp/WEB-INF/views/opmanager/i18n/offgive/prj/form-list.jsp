...
// 		// 1.cntr_deposit.ozr
// 		oz.sendToActionScript("connection.reportname","/1.cntr_deposit.ozr");
...
//         4.cntr_report.ozr
        oz.sendToActionScript("connection.reportname","/7.cntr_report_prj.ozr");
        oz.sendToActionScript("odi.odinames","7_cntr_report");

        oz.sendToActionScript("odi.7_cntr_report.pcount","8");			// 전달할 파라미터 개수
        oz.sendToActionScript("odi.7_cntr_report.args1","START_DT=${fn:escapeXml(startDt)}");
        oz.sendToActionScript("odi.7_cntr_report.args2","END_DT=${fn:escapeXml(endDt)}");
        oz.sendToActionScript("odi.7_cntr_report.args3","RCEPT_BANK_CODE=${fn:escapeXml(rceptBankCode)}");
        oz.sendToActionScript("odi.7_cntr_report.args4","RCEPT_BANK_NM=${fn:escapeXml(rceptBankNm)}");
        oz.sendToActionScript("odi.7_cntr_report.args5","RCEPT_BANK_CODE_NM=${fn:escapeXml(rceptBankCodeNm)}");
        oz.sendToActionScript("odi.7_cntr_report.args6","CNTR_STTUS_CODE=${fn:escapeXml(cntrSttusCode)}");
        oz.sendToActionScript("odi.7_cntr_report.args7","CNTR_AMT_START=${fn:escapeXml(cntrAmtStart)}");
        oz.sendToActionScript("odi.7_cntr_report.args8","CNTR_AMT_END=${fn:escapeXml(cntrAmtEnd)}");
