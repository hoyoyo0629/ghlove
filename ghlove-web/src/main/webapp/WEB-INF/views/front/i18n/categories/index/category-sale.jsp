	...
	<div id="contents" class="pt10">
		...
		<form:form modelAttribute="itemParam" method="post">
			...
			<div class="category_sort event">
		 		<ul>
		 			<li><a href="javascript:itemSort('ORDERING', 'ASC')" id="ORDERING_ASC" rel="nofollow"><c:out value="${op:message('M00845')}"/></a></li> <!-- 신상품순 -->
		 			<li><a href="javascript:itemSort('HITS', 'DESC')" id="HITS_DESC" rel="nofollow"><c:out value="${op:message('M00846')}"/></a></li> <!-- 인기순 -->
		 			<li><a href="javascript:itemSort('SALE_PRICE', 'DESC')" id="SALE_PRICE_DESC" rel="nofollow"><c:out value="${op:message('M00847')}"/></a></li> <!-- 높은 가격순 -->
		 			<li><a href="javascript:itemSort('SALE_PRICE', 'ASC')" id="SALE_PRICE_ASC" rel="nofollow"><c:out value="${op:message('M00848')}"/></a></li> <!-- 낮은 가격순 -->
		 		</ul>
	 	...
	 	<c:if test="${empty items}">
	 		<div class="no_content"><c:out value="${op:message('M00778')}"/> <!-- 상품이 없습니다. --></div>
	 	</c:if>
