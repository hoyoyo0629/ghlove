...
<div class="popup_wrap">
	<h1 class="popup_title">CTP <c:out value="${op:message('M00088')}"/> <!-- 등록 --></h1>
	...
	<div class="popup_contents">
		<form id="editor_upimage" name="editor_upimage" action="/smarteditor/upload-ctp" method="post"
			...
			<p class="text-info text-sm">
				...
				* <strong>5MB</strong><c:out value="${op:message('M01072')}"/>
					...
					<td>
						<div>
							<button type="button" id="add_file" style="display:none" class="table_btn">
								<span>+ <c:out value="${op:message('M01071')}"/></span></button> <!-- 파일추가 -->
