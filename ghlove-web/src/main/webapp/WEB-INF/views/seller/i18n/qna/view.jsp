				...
				<c:choose>
					<c:when test="${qnaAnswer.answer > '1'}">
						...
						<div class="btn_center">
							...
							<a href="/opmanager/qna/edit/${fn:escapeXml(qnaId)}" class="btn btn-active">수정</a>
						</div>
					</c:when>
					<c:otherwise>
						<div class="btn_center">
							<a href="/opmanager/qna/list" class="btn btn-active"><span><c:out value="${op:message('M00480')}"/></span></a> <!-- 목록 -->
							<a href="/opmanager/qna/delete/${fn:escapeXml(qnaId)}" id="delete_data" class="btn btn-default">삭제</a>
							<a href="/opmanager/qna/answer/${fn:escapeXml(qnaId)}" class="btn btn-active">답변등록</a>
						</div>	
					</c:otherwise>
				</c:choose>
			</div>	
