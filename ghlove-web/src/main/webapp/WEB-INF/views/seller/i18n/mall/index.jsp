...
<jsp:include page="./include/inc_header.jsp" />
			...
			<div class="mall-category">
				<ul>
					...
					<c:forEach items="${sellerCategories}" var="sellerCategory">
						<li>
							<a href="#" data-categoryclass="${fn:escapeXml(sellerCategory.categoryClass)}" ${fn:escapeXml(sellerCategory.categoryClass == itemParam.categoryClass ? 'class="on"' : '')}>
								${fn:escapeXml(sellerCategory.categoryName)} (${fn:escapeXml(sellerCategory.itemCount)})
							</a>
						</li>
					</c:forEach>
				</ul>
	 	...
	 	<div class="category_list">
	 		<ul class="item_list type_${fn:escapeXml(itemParam.listType)}">
...
function itemSearchOptionActive() {
	...
	var sort = '${fn:escapeXml(itemParam.sort)}';
	var listType = 'list_type_${fn:escapeXml(itemParam.listType)}';
