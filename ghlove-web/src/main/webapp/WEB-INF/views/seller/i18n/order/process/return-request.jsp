...
<div class="popup_wrap">
	<h3 class="popup_title"><span>${fn:escapeXml(orderReturnApply.orderItem.orderCode)} - 반품 요청 정보</span></h3>
				...
				<table class="board_write_table">
					...
					<tbody id="order_items">
						...
						<tr>   
							...
							<td colspan="2" class="tleft">
								<div>
									${fn:escapeXml(orderReturnApply.returnReasonText)}
								</div>
							</td>
						</tr>
						<tr>   
								...
								<div>
									<c:choose>
										<c:when test="${orderReturnApply.returnShippingStartFlag == 'Y'}">
											택배사 : ${fn:escapeXml(orderReturnApply.returnShippingCompanyName)}, 송장번호 : ${fn:escapeXml(orderReturnApply.returnShippingNumber)}<br/>
