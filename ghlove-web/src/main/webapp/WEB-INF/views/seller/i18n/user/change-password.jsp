	...
	<div class="login_area">
		<form id="changeForm" method="POST" action="/seller/login-change-password">
			<fieldset>
				...
				<div class="inputs">
					<p>
						<span class="label" style="width: 165px;"><c:out value='${op:message("M00081")}'/></span> <!-- 아이디 -->
					...
					<p>
						...
						<span class="label" style="width: 165px;">현재 <c:out value='${op:message("M00150")}'/></span> <!-- 비밀번호 -->
						<input type="password" name="password" maxlength="20" class="required" title="현재 ${op:message('M00150')}"  onkeyup="javascript:checkCapsLock(event, 'passwordWarn');"/>
						<div id="passwordWarn" style="display:none;" class="red">CAPS LOCK 키가 동작 중입니다. 대문자로 입력됩니다.</div>
					</p>
					<p>
						<span class="label" style="width: 165px;">변경할 <c:out value='${op:message("M00150")}'/></span> <!-- 비밀번호 -->
					...
					<p>
						<span class="label" style="width: 165px;">변경할 <c:out value='${op:message("M00150")}'/> 재입력</span> <!-- 비밀번호 -->
...
<script type="text/javascript">
	$(function() {
		$('#changeForm').validator(function() {
			...
			if($('input[name=changePassword]').val().indexOf($('input[name=loginId]').val()) > -1){
