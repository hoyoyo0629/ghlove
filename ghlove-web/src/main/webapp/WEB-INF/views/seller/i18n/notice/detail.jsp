		...
		<div class="board_view_type01 ">
	 		<table cellpadding="0" cellspacing="0" summary="" class="board_list_table">
	 			...
	 			<tbody>
	 				...
	 				<tr>
	 					<td class="label"><c:out value="${notice.subject}"/></td>
	 					<td><c:out value="${op:date(notice.createdDate)}"/></td>
	 					<td class="last"><c:out value="${notice.hits}"/></td>
	 				</tr>
	 				<tr>
	 				...
	 				<tr>
	 					<td colspan="3" class="tleft">
	 						...
	 						<a href="/seller/notice/view/${fn:escapeXml(beforeNotice.noticeId)}" style="padding-right:20px;"><c:out value="${beforeNotice.subject}"/></a>
	 					</td>
	 				</tr>
	 				</c:if>
	 				<c:if test="${beforeNotice.noticeId == 0}">
					...
					<c:if test="${afterNotice.noticeId != 0}">
	 				<tr>
	 					<td colspan="3" class="tleft">
	 						...
	 						<a href="/seller/notice/view/${fn:escapeXml(afterNotice.noticeId)}" style="padding-right:20px;"><c:out value="${afterNotice.subject}"/></a>
	 					</td>
	 				</tr>
	 				</c:if>
	 				<c:if test="${afterNotice.noticeId == 0}">
