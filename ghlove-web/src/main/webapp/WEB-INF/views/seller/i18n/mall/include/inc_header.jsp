	...
	<div id="seller-mall-header">
		<div class="mall-wrap">
			...
			<ul class="mall-util-menu">
				<li><a href="/mall/${op:removeIframe(seller.loginId)}" class="home"><span class="glyphicon glyphicon-home"></span> <c:out value="${seller.sellerName}"/></a></li>
	...
	<div class="mall-wrap">
		<div class="mall-header">
			<div class="mall-top-content">
				<c:out value="${seller.headerContent}"/>
			</div>
			<%--
			...
			<div class="mall-menu">
				<ul>
					<li><a href="/mall/${op:removeIframe(seller.loginId)}">메인</a></li>
					<%-- 
					<li><a href="#">공지사항</a></li>
					--%>
					<li><a href="/mall/${op:removeIframe(seller.loginId)}/qna">Q&A</a></li>
					<li><a href="/mall/${op:removeIframe(seller.loginId)}/review">리뷰</a></li>
				</ul>
				<div class="mall-search">
					<form id="MallSearchForm" action="/mall/${op:removeIframe(seller.loginId)}">
						<input type="hidden" name="where" value="ITEM_NAME" />
						<input type="text" name="query" class="form-query" value="${op:removeIframe(itemParam.query)}" />
