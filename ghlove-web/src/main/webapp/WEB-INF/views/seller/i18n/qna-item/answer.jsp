        ...
        <c:if test="${qna.qnaAnswer == null || qna.qnaAnswer.qnaAnswerId == 0}">
	        <div class="btn_all btn_right mb15">
	            <div class="flex_box gap-08">
	                ...
	                <button type="button" class="btn btn-defualt btn-mini" onclick="location.href='/seller/qna-item/list';"><c:out value="${op:message('M00480')}"/></button><!-- 목록 -->
	            </div>
	        </div>
        </c:if>
                            ...
                            <div>
                                <c:choose>
									<c:when test="${qna.userId > 0 && !empty qna.loginId}">
										<c:out value="${qna.userName} (${qna.loginId})"/>
									</c:when>
	                    ...
	                    <tr>
	                        ...
	                        <td colspan="3">
	                            <div class="flex_box gap-08 item-center">
	                                <form:input path="title" title="${op:message('답변제목')}" class="input_txt required _filter full" type="text" /><!-- 답변제목 -->
	                            </div>
	                        </td>
	                    </tr>
	                    <tr>
	                        ...
	                        <td colspan="3">
	                            <div class="flex_box gap-08 item-center">
	                                <span class="placeholder_wrap">
	                                    ...
	                                    <form:textarea path="answer" cols="30" rows="10" maxlength="140" class="required _filter" title="${op:message('M00477')}"></form:textarea><!-- 답변내용 -->
	                                </span>
	                            </div>
	                        </td>
	                    </tr>
...
function deleteQna(qnaId) {
	if (confirm("${op:message('M00196')}")) {			// 삭제하시겠습니까?
		location.href="/seller/qna-item/delete/"+ qnaId;
	}
}
...
function deleteQnaAnswer(qnaId) {
	if (confirm("${op:message('M00196')}")) {			// 삭제하시겠습니까?
		location.href="/seller/qna-item/answer/delete/"+ qnaId;
	}
}
