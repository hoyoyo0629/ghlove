	      		...
	      		<div class="buttons">
	      			...
	      			<c:if test="${hasModifyPermission}">
		      			<div class="float text-right">
		      				<button type="button" class="btn btn-active btn-sm btn-create">신규<c:out value='${op:message(\'M00088\')}'/></button> <!-- 등록 -->
							<button type="button" class="btn btn-default btn-sm btn-edit hide"><c:out value='${op:message(\'M00087\')}'/></button> <!-- 수정 -->
							<a href="javascript:shipmentDelete();" class="btn btn-default btn-sm btn-delete hide"><c:out value='${op:message(\'M00074\')}'/></a> <!-- 삭제 -->
		      			</div>
	      			</c:if>
	      		</div>
		      	...
		      	<div id="sm-display-area2" style="display: none">
		      		<form id="shipment" action="/seller/shipment-return/create" method="post">
						...
						<p class="popup_btns">
							...
							<button type="submit" class="btn btn-active btn-edit btn-edit1 hide"><c:out value='${op:message(\'M00087\')}'/></button> <!-- 수정 -->
