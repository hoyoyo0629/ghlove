...
span.require {color: #e84700; margin-left: 5px;}
		...
		<form:form modelAttribute="item" method="post">
			<input type="hidden" name="sellerId" id="sellerId" value="${fn:escapeXml(sellerContext.seller.sellerId)}"/>
			<input type="hidden" name="sellerName" id="sellerName" value="${fn:escapeXml(sellerContext.seller.sellerName)}"/>
