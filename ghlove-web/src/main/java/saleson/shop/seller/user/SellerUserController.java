...
public class SellerUserController {
    ...
    public String list(Model model, UserSearchParam userSearchParam) {
        ...
        if (SellerUtils.isSellerLogin() && !UserUtils.isSellerMasterUser()) {
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "======== createAction UserException ==========");
        }
    ...
    public JsonView findUser(@RequestParam("loginId") String loginId) {
        ...
        try {
            ...
            flag = false;
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "======== findUser UserException ==========");
        }
    ...
    public String edit (Model model, @PathVariable("id") long id) {
        ...
        if (SellerUtils.isSellerLogin() && id != UserUtils.getSellerUserId()) {
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "======== edit UserException ==========");
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "======== editAction UserException ==========");
        }
...
//            log.error("ERROR: {}", e.getMessage(), e);
            log.error("ERROR: {}", "======== deleteList UserException ==========");
