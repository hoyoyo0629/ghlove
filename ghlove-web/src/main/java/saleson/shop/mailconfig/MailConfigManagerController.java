...
public class MailConfigManagerController {
	...
	public String createAction(MailConfig mailConfig, Model model) {
		...
		return ViewUtils.redirect("/opmanager/mail-config/edit/" + mailConfig.getTemplateId(), MessageUtils.getMessage("M00288")); // 등록되었습니다. 
	}
	...
	public String editAction(Model model, MailConfig mailConfig) {
		...
		return ViewUtils.redirect("/opmanager/mail-config/edit/" + mailConfig.getTemplateId(), MessageUtils.getMessage("M00289")); // 수정되었습니다.
	}
	...
	public String deleteAction(Model model, MailConfig mailConfig) {
		...
		return ViewUtils.redirect("/opmanager/mail-config/list", MessageUtils.getMessage("M00205")); // 삭제되었습니다.
