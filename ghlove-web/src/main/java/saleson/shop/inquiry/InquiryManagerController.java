...
public class InquiryManagerController {
    ...
    public String inquiryDelete(InquiryParam inquiryParam) {
        ...
        return ViewUtils.redirect("/opmanager/inquiry/list", "삭제되었습니다.");
    }
    ...
    public void downloadImage(Inquiry inquiry, HttpServletResponse response) {
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream();
            ...
            logger.error("DOWNLOAD ERROR : " + getClass().getName() + " :: downloadImage IOException ===============");
     ...
     */
    @PostMapping("list")
    public String searchInquiryList(@ModelAttribute InquiryParam inquiryParam, Model model) {
    	return inquiryList(inquiryParam,model);
    }
}