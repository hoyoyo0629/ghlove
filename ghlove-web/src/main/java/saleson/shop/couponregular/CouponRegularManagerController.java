...
public class CouponRegularManagerController {
	...
	public String createAction(Model model, Coupon coupon) {
		...
		return ViewUtils.redirect("/opmanager/coupon-regular/list", MessageUtils.getMessage("M00288")); // 등록되었습니다. 
	...
	public String editAction(Model model, Coupon coupon) {
		...
		return ViewUtils.redirect("/opmanager/coupon-regular/list", MessageUtils.getMessage("M00289")); 	// 수정되었습니다. 
