...
public class AttendanceManagerController {
	...
	public String createAction(Model model, Attendance attendance) {
		...
		return ViewUtils.redirect("/opmanager/attendance/list", MessageUtils.getMessage("M00288")); 	// 등록되었습니다.
	...
	public String checkedDelete(Model model, AttendanceParam attendanceParam) {
		...
		return ViewUtils.redirect("/opmanager/attendance/list", MessageUtils.getMessage("M00205")); // 삭제되었습니다.
    ...
    public String editAction(Model model, Attendance attendance) {
        ...
        return ViewUtils.redirect("/opmanager/attendance/list", MessageUtils.getMessage("M00289")); 	// 수정되었습니다.
