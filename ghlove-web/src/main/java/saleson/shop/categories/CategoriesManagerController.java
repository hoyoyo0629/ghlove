...
public class CategoriesManagerController {
	...
	public String createAction(Model model, Categories categories) {
		...
		return ViewUtils.redirect(redirectUri, MessageUtils.getMessage("M00288"));	// 등록되었습니다. 
	...
	public String lowCreateAction(Model model, Categories categories) {
		...
		return ViewUtils.redirect("/opmanager/categories/list", MessageUtils.getMessage("M00288"));	// 등록되었습니다. 
	...
	public String editAction(@RequestParam(value="cateGroupId") String cateGroupId, Categories categories, Model model) {
		...
		return ViewUtils.redirect("/opmanager/categories/list?categoryGroupId=" + cateGroupId, MessageUtils.getMessage("M00289"));	// 수정되었습니다.  
