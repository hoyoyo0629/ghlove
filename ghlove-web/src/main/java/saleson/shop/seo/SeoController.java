...
public class SeoController {
    ...
    private String makeHtml(Seo seo, OpenGraph openGraph, boolean isBot) {
        ...
        try {
            ...
            //seo
            if (!ObjectUtils.isEmpty(seo.getTitle())) {
            ...
            if (!ObjectUtils.isEmpty(seo.getHeaderContents1())) {
