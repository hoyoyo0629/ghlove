...
public class SmsConfigManagerController {
	...
	public String createAction(SmsConfig smsConfig, Model model) {
		...
		return ViewUtils.redirect("/opmanager/sms-config/edit/" + smsConfig.getTemplateId(), MessageUtils.getMessage("M00288")); // 등록되었습니다. 
	}
	...
	public String editAction(Model model, SmsConfig smsConfig) {
		...
		return ViewUtils.redirect("/opmanager/sms-config/edit/" + smsConfig.getTemplateId(), MessageUtils.getMessage("M00289")); // 수정되었습니다.
	}
