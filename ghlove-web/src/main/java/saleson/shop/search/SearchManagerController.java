...
public class SearchManagerController {
	...
	public String list(SearchRecommendParam searchRecommendParam, Model model) {
		...
		Pagination pagination = Pagination.getInstance(searchCount, searchRecommendParam.getItemsPerPage());
		searchRecommendParam.setPagination(pagination);
	...
	public String checkedDelete(Model model, SearchRecommendParam searchRecommendParam) {
		...
		return ViewUtils.redirect("/opmanager/search/list", MessageUtils.getMessage("M00205")); // 삭제되었습니다. 
