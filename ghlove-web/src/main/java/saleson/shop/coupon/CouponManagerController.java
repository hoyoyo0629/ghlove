...
public class CouponManagerController {
	...
	public String createAction(Coupon coupon) {
		...
		return ViewUtils.redirect("/opmanager/coupon/list", MessageUtils.getMessage("M00288")); // 등록되었습니다. 
	...
	public String editAction(Model model, Coupon coupon) {
		...
		return ViewUtils.redirect("/opmanager/coupon/list", MessageUtils.getMessage("M00289")); 	// 수정되었습니다. 
	...
	public String uploadExcelProcess(@RequestParam(value="file", required=false) MultipartFile multipartFile,
		...
		try {
			List<Item> couponItems = couponService.insertItemExcelData(multipartFile);
			model.addAttribute("items", couponItems);
			model.addAttribute("size", chosenItemSize);
		} catch (RuntimeException e) {
//			return e.getMessage();
//			return MessageUtils.getMessage("실패했습니다.");			// 실패했습니다.
			return "실패했습니다.";			// 실패했습니다.
		}
