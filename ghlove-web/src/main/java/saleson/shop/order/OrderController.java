...
import saleson.shop.order.payment.OrderPaymentService;
...
//    private final OrderCancelFailService orderCancelFailService;
//
//
...
//	 */
//	@GetMapping("/step1")
//	public String step1(OrderParam orderParam, HttpSession session, Model model) {
//
//		orderLogService.put("");
//
...
//			log.debug("order save() : {}", e.getErrorMessage());
...
//
//			throw new UserException(e.getErrorMessage(), "/order/step1");
//		}
//
...
//				String javascript = "opener.paycoErrorMessage('" + paycoResponse.getCode() + "', '" + ox.getErrorMessage() + "', '/cart'); self.close();";
...
//		if (ObjectUtils.isEmpty(cjResult.getCJSResultCode())) {
//			throw new PageNotFoundException();
//		}
//
//		orderLogService.put("");
...
//				log.debug("order cjCallbackUrl : {}", getClass().getName() + " :: handleCjResponse RuntimeException ==============", e);
//				return "9999";
//			}
//		} else {
//			return "9999";
...
//				}
//
//				if (ObjectUtils.isEmpty(orderService.insertOrder(orderParam, pgData, session, request))) {
//					return "ERROR";
//				}
//
...
//			OrderPayment orderPayment = orderPaymentService.getOrderPaymentByPgDataForKcpVacct(kcpRequest.getOrder_no());
//
//			if (orderPayment == null
//				|| orderPayment.getAmount() != Integer.parseInt(kcpRequest.getIpgm_mnyx())) {
//				return "9999";
//			}
//
//			Order order = orderService.getOrderForKcpConfirm(orderPayment);
//			pgData.setOrder(order);
//			pgData.setOrderPayment(orderPayment);
//
...
//			log.error("ERROR: {}", getClass().getName() + " :: handleNicepayResponse RuntimeException =============", e);
//			return "ERROR";
//		}
//	}
//
...
//
//		if (ObjectUtils.isEmpty(ex.getJavascript())) {
//			return ViewUtils.redirect(ex.getRedirectUrl(), ex.getErrorMessage());
//		} else {
//			return ViewUtils.redirect(ex.getRedirectUrl(), ex.getErrorMessage(), ex.getJavascript());
//		}
//	}
//
...
//                return ViewUtils.redirect("/order/step1", oe.getErrorMessage());
...
//            log.error("[/api/order/pay] ERROR : {}", ApiError.SYSTEM_ERROR.getDescription());
//            return ViewUtils.redirect("/order/step1", ApiError.SYSTEM_ERROR.getDescription());
//        }
//
