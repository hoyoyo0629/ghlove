...
public class UmsManagerController {
                ...
                if (UmsType.MESSAGE == d.getUmsType()) {
                    ...
                    if (!ObjectUtils.isEmpty(buttonString)) {
                        ...
                        try {
                        	...
                        	log.error(getClass().getName() + " :: getUmsEdit :: error ::", ignore);
                        }
                    }
    ...
    public String postUmsEdit(Ums ums, @PathVariable("id") long id) {
    	try {
    		...
    		String message = "정보가 없습니다.";
    		return ViewUtils.redirect("/opmanager/ums/list", message);
...
//            }
    		...
    		String message = "UMS 처리중 문제가 발생했습니다.";
    ...
    public String changeCode(Model model, @PathVariable("templateCode") String templateCode) {
        ...
        UmsTemplate umsTemplate = new UmsTemplate(cryptor);
