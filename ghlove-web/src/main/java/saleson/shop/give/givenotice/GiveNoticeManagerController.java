package saleson.shop.give.givenotice;
...
@Controller
@RequestMapping("/opmanager/give/give-notice/**")
@RequestProperty(title="기금사업소개", layout="default", template="opmanager")
public class GiveNoticeManagerController {
	private static final Logger log = LoggerFactory.getLogger(GiveNoticeManagerController.class);
    ...
    public String editAction(RequestContext requestContext, Notice notice){
        ...
        return ViewUtils.redirect("/opmanager/give/give-notice/list", MessageUtils.getMessage("M00289"));
    }
