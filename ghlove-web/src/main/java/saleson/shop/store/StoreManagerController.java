...
//            throw new UserException(e.getMessage());
            ...
            log.error("store create error : {}", "================= createAction RuntimeException ==============");
            throw new UserException("필수 입력 항목을 정확히 입력해 주세요.");
        }
    ...
    public String editAction(@PathVariable("id") Long id,
        ...
        try {
            ...
            log.error("store edit error : {}", "=========== editAction UserException ==========");
            return ViewUtils.redirect("/opmanager/store/list", "판매처 정보가 없습니다.");
        } catch (RuntimeException e) {
//          log.error("store edit error : {}", e.getMessage(), e);
//          throw new UserException(e.getMessage());
          log.error("store edit error : {}", "=========== editAction RuntimeException ==========");
          throw new UserException("필수 입력 항목을 정확히 입력해 주세요.");
      }
...
//            return JsonViewUtils.failure(e.getMessage());
            log.error("store delete-list error : {}", "========== delete UserException ==========");
