...
//     * @throws Exception
//     */
//    private void setBaseModelForGiftItemList(Model model, GiftItemDto giftItemDto, Pageable pageable) {
//
...
//        	log.error("ERROR: {}", getClass().getName() + " :: list RuntimeException ================");
...
//        } catch (RuntimeException e) {
////			log.error("ERROR: {}", e.getMessage(), e);
//        	log.error("ERROR: {}", getClass().getName() + " :: edit RuntimeException ================");
...
//        } catch (RuntimeException e) {
////			log.error("ERROR: {}", e.getMessage(), e);
//        	log.error("ERROR: {}", getClass().getName() + " :: deleteItemImage RuntimeException ================");
...
//        } catch (RuntimeException e) {
////			log.error("ERROR: {}", e.getMessage(), e);
//        	log.error("ERROR: {}", getClass().getName() + " :: logList RuntimeException ================");
//            throw new GiftItemException("사은품 목록 처리에 문제가 발생 했습니다.");
//        }
//
...
//        } catch (RuntimeException e) {
////			log.error("ERROR: {}", e.getMessage(), e);
//        	log.error("ERROR: {}", getClass().getName() + " :: findItem RuntimeException ================");
//            throw new GiftItemException("사은품 목록 처리에 문제가 발생 했습니다.");
//        }
//
//        return "view";
