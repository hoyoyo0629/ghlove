...
public class EventLogController {
    ...
    public JsonView item(HttpServletRequest request, @RequestBody EventLogParam param) {
        ...
        try {
            ...
            log.error("event item view log error [{}] - {}", param.getId(), getClass().getName() + " :: item RuntimeException ================");
        }
...
//            log.error("event join user log error [{}] - {}", param.getId(), ignore.getMessage(),ignore);
            log.error("event item view log error [{}] - {}", param.getId(), getClass().getName() + " :: joinUser RuntimeException ================");
        }
...
//            log.error("event featured log error [{}] - {}", param.getId(), ignore.getMessage(),ignore);
            log.error("event item view log error [{}] - {}", param.getId(), getClass().getName() + " :: featured RuntimeException ================");
        }
...
//            log.error("event order error [{}] - {}", param.getId(), ignore.getMessage(),ignore);
            log.error("event item view log error [{}] - {}", param.getId(), getClass().getName() + " :: order RuntimeException ================");
        }
