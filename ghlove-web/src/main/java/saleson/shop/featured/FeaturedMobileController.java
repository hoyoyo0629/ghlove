...
public class FeaturedMobileController {
	...
	public String list(Model model, FeaturedParam featuredParam, CategoriesEditParam categoriesEditParam) {
		...
		return makeList(model, featuredParam, categoriesEditParam, "/featured/list", false);
	...
	public String moreList(Model model, FeaturedParam featuredParam, CategoriesEditParam categoriesEditParam) {
		
		return makeList(model, featuredParam, categoriesEditParam, "/include/pages-item-list", true);
	 ...
	 * @return
	 */
	private String makeList(Model model, FeaturedParam featuredParam, CategoriesEditParam categoriesEditParam,
			String returnPath, boolean isMore) {
		
			featuredParam.setFeaturedType("1"); 	// 모바일
