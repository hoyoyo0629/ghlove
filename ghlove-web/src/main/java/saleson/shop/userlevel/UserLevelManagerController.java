...
public class UserLevelManagerController {
	...
	public String createAction(RequestContext requestContext, Model model,UserLevel userLevel,
			@RequestParam(value="uploadfile[]", required=false) MultipartFile[] multipartFiles) throws IOException {
	...
	public String editAction(RequestContext requestContext, Model model,
			UserLevel userLevel, @RequestParam(value="uploadfile[]", required=false) MultipartFile[] multipartFiles) throws IOException {
