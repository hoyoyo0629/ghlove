...
import saleson.common.interceptor.ActionLogHandlerInterceptor;
import saleson.common.interceptor.OpmanagerHandlerInterceptor;
import saleson.common.interceptor.OpmanagerIpAuthenticationHandlerInterceptor;
import saleson.common.interceptor.SellerHandlerInterceptor;
...
public class MvcConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		;
//		registry.addResourceHandler("/upload/**")					// 모든 파일 접근 가능해서 아래로 추가함
...
//				.addResolver(new PathResourceResolver())
//		;
		registry.addResourceHandler("/upload/locgovItem/**")		// 지자체 몰 배경 사진
			.addResourceLocations(storageResourceLocation + "/upload/locgovItem/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/featured/**")			// 지역 이벤트 사진
			.addResourceLocations(storageResourceLocation + "/upload/featured/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/item/**")				// 답례품 사진
			.addResourceLocations(storageResourceLocation + "/upload/item/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/review/**")			// 후기 사진
			.addResourceLocations(storageResourceLocation + "/upload/review/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/item-review/**")			// 후기 사진
			.addResourceLocations(storageResourceLocation + "/upload/item-review/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/rc_upload_file/**")	// 리얼커머스 이관 사진
			.addResourceLocations(storageResourceLocation + "/upload/rc_upload_file/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/qna-open/**")			// qna 사진
			.addResourceLocations(storageResourceLocation + "/upload/qna-open/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/help/**")				// 도움말(구현되어있지 않음)
			.addResourceLocations(storageResourceLocation + "/upload/help/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/data-board/**")		// 자료실(구현되어있지 않음)
			.addResourceLocations(storageResourceLocation + "/upload/data-board/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/editor/**")		// 스마트에디터 이미지 경로
			.addResourceLocations(storageResourceLocation + "/upload/editor/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/representativeBanner/**")		// 대표배너
			.addResourceLocations(storageResourceLocation + "/upload/representativeBanner/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/popup/**")		// 팝업 이미지
			.addResourceLocations(storageResourceLocation + "/upload/popup/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/main-banner/**")		// 메인페이지 배너 이미지
			.addResourceLocations(storageResourceLocation + "/upload/main-banner/")
			.setCachePeriod(3600)
			.resourceChain(true)
			.addResolver(new EncodedResourceResolver())
			.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/prj/**")		//
		.addResourceLocations(storageResourceLocation + "/upload/prj/")
		.setCachePeriod(3600)
		.resourceChain(true)
		.addResolver(new EncodedResourceResolver())
		.addResolver(new PathResourceResolver())
		;
		registry.addResourceHandler("/upload/lclgvHnrUserMng/**")		//
		.addResourceLocations(storageResourceLocation + "/upload/lclgvHnrUserMng/")
		.setCachePeriod(3600)
		.resourceChain(true)
		.addResolver(new EncodedResourceResolver())
		.addResolver(new PathResourceResolver())
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(sellerIpAuthenticationHandlerInterceptor())
				.addPathPatterns("/seller/**")
				.excludePathPatterns(excludePath);
	...
	@Bean
	public SellerIpAuthenticationHandlerInterceptor sellerIpAuthenticationHandlerInterceptor() {
		return new SellerIpAuthenticationHandlerInterceptor();
	}
