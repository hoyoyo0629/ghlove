...
public class DemoController {
    ...
    @RequestProperty(layout="blank", title="메세")
    ...
    public String yourIp(HttpServletRequest request, Model model) {
        ...
        model.addAttribute("ip", CommonUtils.getClientIp(request));
    ...
    public String yourIp(HttpServletRequest request, CommonCode commonCode, Model model) {
        ...
        if (ObjectUtils.isEmpty(commonCode.getAuthCode()) || ObjectUtils.isEmpty(commonCode.getId())) {
    ...
    public String allowIp(HttpServletRequest request, HttpSession session, Model model) {
        ...
        model.addAttribute("remoteAddress", CommonUtils.getClientIp(request));
...
//		}
        ...
        if ("INSERT".equals(mode)) {
            ...
            if (ObjectUtils.isEmpty(commonCode.getId())) {
